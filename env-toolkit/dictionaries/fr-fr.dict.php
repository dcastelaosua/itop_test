...
- Sinon, le logo compact de l\'application sera utilisé',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Une Source de données ne peut alimenter qu\'une seule classe iTop',
...
Ce lien est affiché dans le tootip du cadenas, visible sur les objets iTop synchronisés',
...
L\'hyperlien est affiché dans le tootip du cadenas, visible sur les objets iTop synchronisés',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => 'Politique de recherche',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => 'Pour retrouver le(s) objet(s) iTop correspondant à l\'objet source :
...
Soit on recherche directement l\'objet sur son id qui doit être égal au "primary_key" de la source',
	...
	'Class:SynchroDataSource/Attribute:action_on_zero+' => 'Que fait-on si aucun objet iTop ne correspond à l\'objet source',
	'Class:SynchroDataSource/Attribute:action_on_one' => 'Action si un',
	'Class:SynchroDataSource/Attribute:action_on_one+' => 'Que fait-on lorsqu\'un seul objet iTop correspond à l\'objet source',
	'Class:SynchroDataSource/Attribute:action_on_multiple' => 'Action si plusieurs',
	'Class:SynchroDataSource/Attribute:action_on_multiple+' => 'Que fait-on lorsque plus d\'un objet iTop correspond à l\'objet source',
...
Plusieurs champs peuvent ainsi être modifiés lors d\'une "mise à jour" en application de la politique d\'effacement',
	...
	'Class:SynchroDataSource/Attribute:delete_policy+' => 'Que fait-on avec l\'objet iTop synchronisé lorsque objet source n\'est plus présent ?
"Ignorer" : on ne fait rien, l\'objet demeure dans iTop inchangé,
"Effacer" : l\'objet iTop est supprimé ainsi que son replica,
"Mettre à jour" : les régles décrites dans le champ "mise à jour" sont appliquées à l\'objet iTop qui est donc modifié,
"Mettre à jour puis effacer" : on effectue immédiatement une mise à jour, et lorsque la durée de rétention est atteinte, on supprime l\'objet iTop',
...
Lorsqu\'on execute l\'audit sur un domaine, toutes les catégories d\'audit incluses sont vérifiées en même temps et seulement celles là',
	...
	'Class:User/Attribute:login+' => 'Indentifiant de ce compte, doit être unique au sein d\'iTop',
	'Class:User/Attribute:language' => 'Langue',
	'Class:User/Attribute:language+' => 'Langue de défaut d\'iTop pour cet utilisateur, à choisir parmi les langues dans lequelles iTop a été traduit.',
...
<tr><td>s</td><td>secondes (sur 2 chiffres: 00..59)</td></tr>
	...
	'Menu:UserManagementMenu+' => 'Qui peut se connecter à iTop et y faire quoi ?',
...
- L\'équipe R&amp;D',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Bienvenue sur iTop 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Félicitations, vous avez atterri sur iTop Fullmoon !</div>
<br>
<div>Nous sommes ravis de vous présenter cette nouvelle version.</div>
<br>
<div>En plus d\'introduire de nouvelles fonctionnalités telles que la Newsroom, iTop 3.2 inclut des correctifs de sécurité critiques, une meilleure accessibilité et d\'autres améliorations significatives visant à vous apporter stabilité et sécurité.</div>
<br>
...
<div>Paramétrez vos préférences iTop pour une expérience personnalisée.</div>',
	...
	'UI:WelcomePopup:Message:320_02_Newsroom:Description' => '<div>Dites adieu aux boîtes de réception encombrées et bonjour aux alertes personnalisées grâce à la <a href="%1$s" target="_blank">Newsroom d\'iTop</a> !</div>
<br>
...
<br>
<div>Essayez-le dès aujourd\'hui et optimisez la communication de votre iTop !</div>',
...
<div>Accédez à votre <a href="%1$s" target="_blank">centre de notifications</a> via la newsroom ou vos préférences et évitez la surcharge d\'information sur vos canaux de communication !</div>',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Title' => 'Accessibilité de l\'interface utilisateur d\'iTop',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Description' => '<div>Afin d\'assurer l\'accessibilité d\'iTop, notre équipe a travaillé sur de <a href="%1$s" target="_blank">nouveaux thèmes pour la console</a>. Conformes aux normes WCAG, ces interfaces utilisateur visent à faciliter l\'utilisation de la solution par les utilisateurs souffrant de déficiences visuelles :
<ul>
	...
	'UI:WelcomePopup:Message:320_04_PowerfulNotifications_AdminOnly:Description' => '<div>La Newsroom d\'iTop vous offre une nouvelle façon <a href="%1$s" target="_blank">d\'<b>automatiser</b> vos alertes en fonction d\'événements récurrents</a>, ce qui vous permet de définir facilement des règles qui vous conviennent.</div>
...
<div>Configurez-le dès aujourd\'hui et voyez à quel point votre processus d\'alerte peut être plus efficace !</div>',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Vos news iTop',
...
Soit demandez à votre administrateur système s\'il reste de la place disque disponible sur le serveur',
	...
	'config-not-allowed-in-demo' => 'Désolé, iTop est en <b>mode démonstration</b> : la configuration ne peut pas être modifiée.',
...
- $oResponse peut être null dans certains cas (ex : échec de l\'envoi de la requête)',
	...
	'Class:ActioniTopWebhook' => 'Action par API REST iTop',
