...
Operadores:<br/>
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Una fuente de datos sincronizada solo puede completar una única clase iTop',
	...
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Utilice los atributos": iTop El objeto coincide con los valores de réplica para cada atributo Synchro marcado para reconciliación.
"Usar clave_primaria": se espera que la columna clave_primaria de la réplica contenga el identificador de iTop objeto',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Sus noticias de iTop',
...
o pregunte al administador de iTop si el servidor que ha quedado sin espacio en disco.',
	...
	'config-not-allowed-in-demo' => 'Lo sentimos, iTop está en <b>modo de demostración</b>: el archivo de configuración no se puede editar.',
	'config-interactive-not-allowed' => 'iTop edición interactiva de la configuración como deshabilitada. Consulte <code>\'config_editor\' => \'disabled\'</code> en el archivo de configuración.',
...
Rather base your condition on \'Drop-down list\' or \'Read-only\' template field types',
	...
	'iTopUpdate:UI:Setup' => 'Configuración iTop',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Inicie configuración iTop',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Esto iniciará configuración iTop, ¿Está seguro?',
...
Borre el campo para recalcular el valor predeterminado',
	...
	'Class:PersonalToken+' => 'Token Personal para acceder a iTop servicios web, importación, exportación, REST y sincronización de datos',
	...
	'Class:UserToken+' => 'Usuario para aplicaciones remotas que acceden a iTop servicios web',
...
IMPORTANTE: Si se habilita, el \'mensaje\' será ignorados.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Incluya un botón debajo del mensaje para eliminar el objeto en iTop',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Incluir un botón debajo del mensaje para editar el objeto en iTop',
...
IMPORTANTE: Si se habilita, el \'mensaje\' y toda la \'información bot\' serán ignorados.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Incluir un botón debajo del mensaje para eliminar el objeto en iTop',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Incluir un botón debajo del mensaje para editar el objeto en iTop',
...
IMPORTANTE: Si se habilita, el atributo \'JSON data\' será ignorado.',
	...
	'Class:RemoteApplicationType/Attribute:action_explanation+' => 'Explicación sobre cómo configurar una acción webhook en iTop (activada por un disparador) para esa aplicación. Por ejemplo, cómo construir una carga o qué esperar en la respuesta.',
