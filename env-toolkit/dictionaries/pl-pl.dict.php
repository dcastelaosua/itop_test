...
- W przeciwnym razie użyte zostanie kompaktowe logo aplikacji',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Synchroniczne źródło danych może zapełnić tylko jedną klasę iTop',
	...
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Użyj atrybutów": iTop obiekt odpowiada wartościom replik dla każdego atrybutu Synchro oznaczonego jako Uzgadnianie.
"Użyj klucza podstawowego": oczekuje się, że kolumna klucz_podstawowy repliki będzie zawierać identyfikator obiektu iTop',
...
- Zespół R&amp;D',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Witaj w iTop 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Gratulacje, trafiłeś do iTop Fullmoon!</div>
<br>
<div>Z radością ogłaszamy tę nową wersję. </div>
<div>Oprócz wprowadzenia nowych funkcji, takich jak Newsroom, iTop wersja 3.2 zawiera krytyczne poprawki bezpieczeństwa, zwiększoną dostępność i inne znaczące ulepszenia mające na celu zapewnienie stabilności i bezpieczeństwa.</div>
<br>
<div>Odkryj wszystkie ekscytujące nowe funkcje iTop i bądź na bieżąco z ważnymi powiadomieniami dzięki naszemu nowemu wyskakującemu okienku powitalnemu!</div>
<div>Mamy nadzieję, że spodoba ci się ta wersja tak samo, jak nam podobało się jej wyobrażanie i tworzenie.</div>
<br>
<div>Dostosuj swoją aplikację iTop w preferencjach dotyczących spersonalizowanych doświadczeń.</div>',
	'UI:WelcomePopup:Message:320_02_Newsroom:Title' => 'Przywitaj się z newsroomem',
	'UI:WelcomePopup:Message:320_02_Newsroom:Description' => '<div>Pożegnaj zaśmiecone skrzynki odbiorcze i przywitaj się ze spersonalizowanymi alertami <a href="%1$s" target="_blank">iTop\'s Newsroom</a>!</div>
...
<br>
<div>Wypróbuj już dziś i usprawnij swoje doświadczenie komunikacji w iTop!</div>',
...
<div>Uzyskaj dostęp do swojego centrum powiadomień poprzez newsroom lub poprzez swoje preferencje i unikaj przeciążenia informacjami we wszystkich kanałach komunikacji!</div>',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Title' => 'Dostępność iTop',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Description' => '<div>Aby zapewnić dostępnośćiTop, nasz zespół pracował nad nowymi motywami zaplecza. Zgodny z WCAG, interfejs użytkownika skupia się na ułatwieniu użytkownikom z wadami wzroku korzystania z rozwiązania:
<ul>
	...
	'UI:WelcomePopup:Message:320_04_PowerfulNotifications_AdminOnly:Description' => '<div>iTop Newsroom oferuje nowy sposób <b>automatyzacji</b> alertów na podstawie powtarzających się zdarzeń, dzięki czemu możesz łatwo skonfigurować odpowiednie dla siebie reguły. </div>
...
<div>Skonfiguruj już dziś i przekonaj się, o ile efektywniejszy może być Twój proces alertów!</div>',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Twoje wiadomości iTop',
...
lub zapytaj administratora iTop, czy dysk serwera iTop jest pełny.',
	...
	'config-not-allowed-in-demo' => 'Sorry, iTop jest w <b>trybie demonstracyjnym</b>: nie można edytować pliku konfiguracyjnego.',
	'config-interactive-not-allowed' => 'iTop interaktywna edycja konfiguracji została wyłączona. Zobacz <code>\'config_editor\' => \'disabled\'</code> w pliku konfiguracyjnym.',
	...
	'iTopUpdate:UI:Setup' => 'Konfiguracja iTop',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Uruchom konfigurację iTop',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Zostanie uruchomiona iTop konfiguracja, jesteś pewien?',
