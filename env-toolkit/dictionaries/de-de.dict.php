...
- Andernfalls wird das kompakte Anwendung-Logo verwendet',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Eine Synchro-Datenquelle kann nur eine iTop-Klasse befüllen.',
	...
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Attribute benutzen": Das iTop-Objekt stimmt mit den Werten der Replica für jedes Synchro-Attribut überein, das für den Abgleich gekennzeichnet ist.
"Feld primary_key benutzen": Die Spalte primary_key des Replicas soll den Bezeichner des iTop-Objekts enthalten.',
...
"Ignorieren": Nichts tun, das zugehörige Objekt verbleibt unverändert in iTop.
"Löschen": Löschen des zugehörigen Objekts in iTop (und der Replica in der Datentabelle).
...
"Update, danach Löschen": Die "Update-Regeln" anwenden. Wenn die Aufbewahrungsdauer abgelaufen ist, "Löschen" durchführen.',
	...
	'Class:User/Attribute:login+' => 'Der Benutzer-Anmeldename muss innerhalb von iTop eindeutig sein',
	...
	'Class:UserInternal+' => 'Benutzer, der innerhalb von iTop definiert wird',
...
- Das Entwicklungsteam',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Willkommen bei iTop 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Herzlichen Glückwunsch, Sie sind auf iTop Fullmoon gelandet!</div>
<br>
<div>Wir freuen uns, diese neue Version anzukündigen.</div>
<div>Neben der Einführung neuer Funktionen wie dem Newsroom enthält iTop 3.2 wichtige Sicherheitsupdates, verbesserte Barrierefreiheit und andere bedeutende Verbesserungen, die auf Stabilität und Sicherheit abzielen.</div>
<br>
<div>Entdecken Sie alle neuen Funktionen von iTop und bleiben Sie mit unserem neuen Willkommens-Popup über wichtige Benachrichtigungen auf dem Laufenden!</div>
...
<br>
<div>Passen Sie Ihre iTop Präferenzen an, um ein personalisiertes Erlebnis zu erhalten.</div>',
	'UI:WelcomePopup:Message:320_02_Newsroom:Title' => 'Sagen Sie "Hallo" zum Newsroom',
	'UI:WelcomePopup:Message:320_02_Newsroom:Description' => '<div>Sagen Sie Auf Wiedersehen zu überfüllten Posteingängen und Hallo zu personalisierten Benachrichtigungen mit dem <b>Newsroom von iTop</b>!</div>
...
<br>
<div>Probieren Sie es noch heute aus und optimieren Sie die Benachrichtigungserfahrung von iTop!</div>',
...
<div>Zugriff auf Ihr <a href="%1$s" target="_blank">Benachrichtigungszentrum</a> über den Newsroom oder über Ihre Präferenzen und vermeiden Sie Informationsüberflutung auf allen Ihren Kommunikationskanälen!</div>',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Title' => 'Barrierefreiheit für die Benutzeroberfläche von iTop',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Description' => '<div>Um die Barrierefreiheit von iTop zu gewährleisten, hat unser Team an <a href="%1$s" target="_blank">neuen Back-Office-Themen</a> gearbeitet. WCAG-konform konzentrieren sich diese Benutzeroberflächen darauf, es Benutzern mit Sehbehinderungen zu erleichtern, die Lösung zu verwenden:
<ul>
	...
	'UI:WelcomePopup:Message:320_04_PowerfulNotifications_AdminOnly:Description' => '<div>Der Newsroom von iTop bietet Ihnen eine neue Möglichkeit, Ihre Benachrichtigungen basierend auf wiederkehrenden Ereignissen zu <b>automatisieren</b>, sodass Sie leicht Regeln einrichten können, die für Sie funktionieren.</div>
...
oder melden Sie dem iTop Administrator diesen Fehler, weil eventuell kein ausreichender Speicherplatz zur Verfügung steht',
	...
	'config-edit-intro' => 'Achtung: Eine falsche Konfiguration kann dazu führen, dass iTop für alle Benutzer unbenutzbar ist!',
	...
	'config-not-allowed-in-demo' => 'Entschuldigung, iTop befindet sich im <b>Demo-Modus</b>: Die Konfigurationsdatei kann nicht bearbeitet werden.',
	'config-interactive-not-allowed' => 'Die interaktive Bearbeitung der iTop Konfiguration wurde deaktiviert. Siehe <code>\'config_editor\' => \'disabled\'</code> in der Konfigurationsdatei.',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Starte iTop Setup',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Hiermit wird der iTop Setup, sind Sie sicher?',
...
Löschen Sie das Feld, um den Standardwert neu zu berechnen.',
	...
	'Class:PersonalToken+' => 'Persönliches Token für den Zugriff iTop Webdienste, Import, Export, REST und Datensynchronisation',
	...
	'Class:UserToken+' => 'Benutzer für den Zugriff auf Remote-Anwendungen iTop Webdienste',
...
WICHTIG: Wenn dies gesetzt ist, wird das Attribut \'Nachricht\' ignoriert.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Fügen Sie einen Button unter der Nachricht ein, um das Objekt in iTop zu löschen',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Fügen Sie einen Button unter der Nachricht ein, um das Objekt in iTop zu bearbeiten',
...
WICHTIG: Wenn dies gesetzt ist, werden das Attribut \'Nachricht\' sowie alle \'Bot-Informationen\' ignoriert.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Fügen Sie einen Button unter der Nachricht ein, um das Objekt in iTop zu löschen',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Fügen Sie einen Button unter der Nachricht ein, um das Objekt in iTop zu bearbeiten',
