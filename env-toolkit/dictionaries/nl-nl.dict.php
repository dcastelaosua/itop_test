...
of vraag de iTop administrator om de opslagruimte van de iTop-server na te kijken',
	...
	'config-not-allowed-in-demo' => 'Sorry, iTop is in <b>demo mode</b>: Het configuratiebestand kan niet aangepast worden.',
	'config-interactive-not-allowed' => 'Interactieve aanpassing van de iTop configuratie is uitgeschackeld. Zie <code>\'config_editor\' => \'disabled\'</code> in het configuratiebestand.',
...
If using OQL, objects proposed are limited to User rights. User Portal scopes are not applied.',
	...
	'iTopUpdate:UI:CannotUpdateUseSetup' => '<b>Aangepaste bestanden gedetecteerd</b>, gedeeltelijke update kan niet uitgevoerd worden.</br>Volg de <a target="_blank" href="%2$s">procedure</a> om iTop manueel te updaten. Je moet de <a href="%1$s">setup</a> gebruiken om de applicatie te updaten.',
	'iTopUpdate:UI:CheckInProgress' => 'Even geduld terwijl de integriteitscontrole loopt',
	'iTopUpdate:UI:SetupLaunch' => 'Start de iTop setup',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Dit zal de iTop setup uitvoeren, ben je zeker?',
...
BELANGRIJK: Indien geconfigureerd, zal \'bericht\' genegeerd worden.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Voeg een knop toe onder het bericht om het object te verwijderen in iTop',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Voeg een knop toe onder het bericht om het object aan te passen in iTop',
...
BELANGRIJK: Indien geconfigureerd, zullen \'bericht\' en alle \'bot-informatie\' genegeerd worden.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Voeg een knop toe onder het bericht om het object te verwijderen in iTop',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Voeg een knop toe onder het bericht om het object aan te passen in iTop',
