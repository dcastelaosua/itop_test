...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:User/Attribute:login+' => 'Account identification string, must be unique within iTop',
	'Class:User/Attribute:language' => 'Language',
	'Class:User/Attribute:language+' => 'Default iTop language for this user, to choose amoungst languages in which iTop was localized . ',
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'Menu:AuditCategories+' => 'Define rules to audit the quality of iTop data',
