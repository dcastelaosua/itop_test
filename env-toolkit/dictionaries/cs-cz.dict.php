...
- V opačném případě se použije kompaktní logo aplikace',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Zdroj dat pro synchronizaci může naplnit pouze jednu třídu iTop',
	...
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Použijte atribut": iTop objekt odpovídá hodnotám replik pro jednotivé atributy synchronizace označené pro odsouhlasení.
"Použít primary_key": sloupec primary_key repliky by měl obsahovat identifikátor objektu iTop',
...
Domény nejčastěji odpovídají skupinám řešitelů, které následně opravují chyby nalezené auditem',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Upozornění v iTop jsou plně nastavitelné. Jsou založena na dvou druzích objektů: <i>trigery (spouštěče) a akce</i>.</p>
<p><i><b>Trigery</b></i> definují, kdy bude oznámení provedeno. Součástí jádra iTop jsou různé trigery, ale další mohou být přidány rožšířením:
<ol>
...
- The R&amp;D Team',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Vítejte v iTop 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Gratulujeme, přistáli jste do iTop Fullmoon!</div>
<br>
<div>Jsme rádi, že vám můžeme představit tuto novou verzi. </div>
<div>Kromě nových funkcionalit, jako je např. Newsroom, iTop obsahuje verze 3.2 bezpečnostní opravy, lepší přístupnost a další významná vylepšení zaměřená na zajištění stability a bezpečnosti.</div>
<br>
<div>Objevte všechny iTop vzrušující nové funkce a zůstaňte informováni o důležitých oznámeních a aktualizacích prostřednictvím nového vyskakovacího okna na uvítanou!</div>
<div>Doufáme, že se vám tato verze bude líbit stejně, jako se nám líbila její tvorba.</div>
<br>
<div>Přizpůsobte si svoje předvolby iTop a získejte tak individuální zážitek.</div>',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Vaše iTop novinky',
...
nebe se zeptejteiTop správce iTop zda není zaplněný disk.',
	...
	'config-not-allowed-in-demo' => 'Omlouvám se, iTop je v <b>předváděcí režimu</b>: Konfigurace nemůže být editována',
	...
	'Organization:Overview:Users' => 'iTop Uživatelé v rámci této organizace',
...
If using OQL, objects proposed are limited to User rights. User Portal scopes are not applied.',
	...
	'Menu:iTopHub:MyExtensions+' => 'Seznam rozšíření nasazených v rámci instance iTop',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Tato rozšíření byla nasazena manuálně a to kopiií souborů do adresáře %1$s instance iTop:',
	...
	'iTopHub:LandingWelcome' => 'Gratuluji! Následující rozšíření jsou úspěšně stažena z iTop Hubu a nasazena v rámci instance iTop.',
