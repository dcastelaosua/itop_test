...
if (!class_exists('TemplatesBaseInstaller'))
{
	...
	class TemplatesBaseInstaller extends ModuleInstallerAPI
	{
		...
		public static function AfterDatabaseCreation(Config $oConfiguration, $sPreviousVersion, $sCurrentVersion)
		{
			...
			SetupLog::Info("Checking for TemplateFields with values in the 'code' field not following the consistency rule: '$sPattern'.");
			...
			if ($iUpdated > 0)
			{
				SetupLog::Info("TemplateFields: $iUpdated TemplateField(s) have been modified.");
			}
			else
			{
				SetupLog::Info("No TemplateField modified.");
			}
		}
