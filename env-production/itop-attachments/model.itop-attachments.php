...
/**
 * Classes and menus for itop-attachments (version 3.2.1)
 *
...
class Attachment extends DBObject
{
  ...
  array (
    0 => 'item_org_id',
		...
		MetaModel::Init_AddAttribute(new AttributeDateTime("expire", array("sql"=>'expire', "is_null_allowed"=>false, "default_value"=>'DATE_ADD(NOW(), INTERVAL 1 DAY)', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("contact_id", array("targetclass"=>'Person', "allowed_values"=>null, "sql"=>'contact_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "allow_target_creation"=>false, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
