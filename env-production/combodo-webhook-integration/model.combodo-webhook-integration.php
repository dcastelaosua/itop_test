<?php
//
// File generated by ... on the 2026-02-12T21:40:40+0100
// Please do not edit manually
//

/**
 * Classes and menus for combodo-webhook-integration (version 1.4.4)
 *
...
class RemoteApplicationType extends Typology
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("remoteapplicationconnections_list", array("linked_class"=>'RemoteApplicationConnection', "ext_key_to_me"=>'remoteapplicationtype_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "with_php_computation"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class RemoteApplicationConnection extends Typology
{
	public static function Init()
	{
		$aParams = array(			'category' => 'grant_by_profile,bizmodel,searchable',
			...
			'image_attcode' => '',
			'state_attcode' => '',
			'reconc_keys' => array('name', 'remoteapplicationtype_id', 'environment'),
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeExternalKey("remoteapplicationtype_id", array("targetclass"=>'RemoteApplicationType', "allowed_values"=>null, "sql"=>'remoteapplicationtype_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeText("url", array("sql"=>'url', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("actions_list", array("linked_class"=>'ActionWebhook', "ext_key_to_me"=>'remoteapplicationconnection_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "with_php_computation"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
;
	 ...
	 * @return string[]
	 */
	public function PrepareHeaders(array $aContextArgs, \EventNotification &$oLog)
	{
		return [];
	}
...
class RemoteiTopConnection extends RemoteApplicationConnection
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("auth_user", array("sql"=>'auth_user', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributePassword("auth_pwd", array("sql"=>'auth_pwd', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("version", array("sql"=>'version', "is_null_allowed"=>false, "default_value"=>'1.3', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class RemoteiTopConnectionToken extends RemoteApplicationConnection
{
	public static function Init()
	{
		$aParams = array(			'category' => 'grant_by_profile,bizmodel,searchable',
			...
			'state_attcode' => '',
			'reconc_keys' => array('name', 'remoteapplicationtype_id', 'environment'),
			'db_table' => 'remoteitopconnectiontoken',
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, null),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("version", array("sql"=>'version', "is_null_allowed"=>false, "default_value"=>'1.3', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("token", array("sql"=>'token', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class RemoteOauthConnection extends RemoteApplicationConnection
{
	public static function Init()
	{
		$aParams = array(			'category' => 'grant_by_profile,bizmodel,searchable',
			...
			'state_attcode' => '',
			'reconc_keys' => array('name', 'remoteapplicationtype_id', 'environment'),
			'db_table' => 'remoteoauthconnection',
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle(null, null, null, null, null, null),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeExternalKey("oauth2client_id", array("targetclass"=>'Oauth2Client', "allowed_values"=>null, "sql"=>'oauth2client_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false, "tracking_level"=>ATTRIBUTE_TRACKING_ALL)));
...
;
	...
	public function PrepareHeaders(array $aContextArgs, \EventNotification &$oLog)
	{
		...
		Combodo\iTop\Service\WebRequestService::GetInstance()->EnrichHeader($this, $aHeaders);
...
class ActionWebhook extends Combodo\iTop\Core\Notification\Action\_ActionWebhook
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeExternalKey("remoteapplicationconnection_id", array("targetclass"=>'RemoteApplicationConnection', "allowed_values"=>null, "sql"=>'remoteapplicationconnection_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("test_remoteapplicationconnection_id", array("targetclass"=>'RemoteApplicationConnection', "allowed_values"=>null, "sql"=>'test_remoteapplicationconnection_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_AUTO, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("method", array("allowed_values"=>new ValueSetEnum("delete,get,head,patch,post,put" ), "display_style"=>'list', "sql"=>'method', "default_value"=>'post', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeText("headers", array("sql"=>'headers', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeText("payload", array("sql"=>'payload', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("prepare_payload_callback", array("sql"=>'prepare_payload_callback', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("process_response_callback", array("sql"=>'process_response_callback', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
;
    ...
    public function EventHook_EVENT_DB_CHECK_TO_WRITE_CheckJSONSyntax(Combodo\iTop\Service\Events\EventData $oEventData)
						{
							if (trim($this->Get('payload')) === '') {
								return ;
							}
							try {
								Combodo\iTop\Core\Notification\Action\_ActionWebhook::JsonDecodeWithError($this->Get('payload'));
							} catch(Combodo\iTop\Core\Notification\Action\Webhook\Exception\WebhookInvalidJsonValueException $e) {
								$this->AddCheckIssue(Dict::S('Class:ActionWebhook/Error:InvalidJSONFormatForPayload'));
							}
						}
	...
	protected function RegisterEventListeners()
	{
		...
		// listenerId = CheckJSONSyntax
		$this->RegisterCRUDListener("EVENT_DB_CHECK_TO_WRITE", 'EventHook_EVENT_DB_CHECK_TO_WRITE_CheckJSONSyntax', 10, 'combodo-webhook-integration');
	}
	 ...
	 */
	static public function GetRemoteApplicationConnectionFromActionWebhook($oAction)
	{
	...
	protected function LogHeaders($sRawHeaders, array $aPreparedHeaders, \EventNotification &$oLog)
	{
		...
		$sObfuscatedRawHeaders = Combodo\iTop\Service\WebRequestService::GetInstance()->ObfuscateRawHeader($sAuthHeaderObfuscated);
		$sObfuscatedPreparedHeaders = Combodo\iTop\Service\WebRequestService::GetInstance()->ObfuscateRawHeader(implode("\n", $aPreparedHeaders));
	 ...
	 * @return array Same structure as $aInputData but with applied params
	 */
	protected function ApplyParamsToValue(array $aContextArgs, $value)
	{
...
protected function ApplyParamsToJson(array $aContextArgs, string $sInputAsJson)
	{
		try {
			...
			$aJsonInputAsArray = static::JsonDecodeWithError($sInputAsJson);
		} catch(Combodo\iTop\Core\Notification\Action\Webhook\Exception\WebhookInvalidJsonValueException $e) {
		...
		$aJsonInputAsArray = $this->ApplyParamsToValue($aContextArgs, $aJsonInputAsArray);
		$sJsonWithReplacedPlaceholders = json_encode($aJsonInputAsArray);
	 ...
	 */
	protected function GetContentType($aHeaders)
	{
...
class ActionSlackNotification extends ActionWebhook
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeHTML("message", array("sql"=>'message', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("include_user_info", array("allowed_values"=>new ValueSetEnum("no,yes" ), "display_style"=>'radio_horizontal', "sql"=>'include_user_info', "default_value"=>'no', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("include_modify_button", array("allowed_values"=>new ValueSetEnum("no,yes" ), "display_style"=>'radio_horizontal', "sql"=>'include_modify_button', "default_value"=>'no', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("include_delete_button", array("allowed_values"=>new ValueSetEnum("no,yes" ), "display_style"=>'radio_horizontal', "sql"=>'include_delete_button', "default_value"=>'no', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("include_other_actions_button", array("allowed_values"=>new ValueSetEnum("no,specify,yes" ), "display_style"=>'radio_horizontal', "sql"=>'include_other_actions_button', "default_value"=>'no', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("specified_other_actions", array("sql"=>'specified_other_actions', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class ActionRocketChatNotification extends ActionWebhook
{
	public static function Init()
	{
		...
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeHTML("message", array("sql"=>'message', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("bot_alias", array("sql"=>'bot_alias', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("bot_url_avatar", array("sql"=>'bot_url_avatar', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("bot_emoji_avatar", array("sql"=>'bot_emoji_avatar', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class ActionMicrosoftTeamsNotification extends ActionWebhook
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("title", array("sql"=>'title', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeHTML("message", array("sql"=>'message', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("theme_color", array("sql"=>'theme_color', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeURL("image_url", array("target"=>'', "sql"=>'image_url', "default_value"=>'', "is_null_allowed"=>true, "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("json_format", array("allowed_values"=>new ValueSetEnum("adaptive_card,message_card" ), "display_style"=>'list', "sql"=>'json_format', "default_value"=>'message_card', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("include_modify_button", array("allowed_values"=>new ValueSetEnum("no,yes" ), "display_style"=>'radio_horizontal', "sql"=>'include_modify_button', "default_value"=>'no', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("include_delete_button", array("allowed_values"=>new ValueSetEnum("no,yes" ), "display_style"=>'radio_horizontal', "sql"=>'include_delete_button', "default_value"=>'no', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("include_other_actions_button", array("allowed_values"=>new ValueSetEnum("no,specify,yes" ), "display_style"=>'radio_horizontal', "sql"=>'include_other_actions_button', "default_value"=>'no', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("specified_other_actions", array("sql"=>'specified_other_actions', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
;
	 ...
	 * @throws \CoreException
	 */
	protected function PreparePayloadMessageCard(array $aContextArgs)
	{
		$aData = array(
			'@type' => 'MessageCard',
	 ...
	 */
	protected function PreparePayloadAdaptiveCard(array $aContextArgs)
	{
		$aData = [
			'type' => 'message',
		];
		...
		if (strlen($sMessage) > 0) {
			$aMessageBlock = [
				"type" => "TextBlock",
	            "text" => static::TransformHTMLToMSTeamsMarkup($sMessage, 'adaptive_card'),
	            "wrap" => true
			];
		}
	 ...
	 * @return array
	 */
	protected function PrepareExtraAttributesForMSTeamsAPI(array $aContextArgs, string $sJsonFormat = 'message_card')
	{
		/** @var \DBObject $oObject */
		$oObject = $aContextArgs['this->object()'];
		$sObjClass = get_class($oObject);
		...
		foreach($aListItems as $sAttCode)
		{
			...
			$aFacts[] = array(
				...
				'value' => static::TransformHTMLToMSTeamsMarkup($sValueAsHtml, $sJsonFormat),
			);
		}
	 ...
	 * @return array
	 */
	protected function PrepareActionsForMSTeamsAPI(array $aContextArgs, string $sJsonFormat = 'message_card')
	{
		$aActionElements = array();
	 ...
	 */
	protected function PrepareActionElementForMSTeamsAPI(string $sLabel, string $sUrl, string $sJsonFormat)
	{
		return match ($sJsonFormat) {
			'message_card' => [
				'@type'   => 'OpenUri',
	 ...
	 * @return string
	 */
	public static function TransformHTMLToMSTeamsMarkup(string $sContent, string $sJsonFormat)
	{
		if (empty($sContent)) {
			return $sContent;
		}
		...
		if ($sJsonFormat === 'adaptive_card') {
			$aReplacementsMatrix[] = array(array('<h1>', '</h1>'), array('**', "**\n\n"));
			$aReplacementsMatrix[] = array(array('<h2>', '</h2>'), array('**', "**\n\n"));
			$aReplacementsMatrix[] = array(array('<h3>', '</h3>'), array('**', "**\n\n"));
			$aReplacementsMatrix[] = array(array('</p>'), "\n\n"); // new line instead of carriage return (which does not seem to be supported)
			$aReplacementsMatrix[] = array(array('<p>'), '');
		}

			// Replace HTML tags (list must contain at least tags from the $aReplacementsMatrix)
		$sAllowedTags = $sJsonFormat === 'message_card' ?
			'<br><strong><b><em><i><del><s><li><a><h1><h2><h3><code><pre>'
			:
			'<br><strong><b><em><i><del><s><li><a><p><h1><h2><h3>'; // code/pre blocs not supported in adaptive_card
		$sContent = strip_tags($sContent, $sAllowedTags); // what about unkown tags ?
...
class EventWebhook extends EventNotification
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("action_finalclass", array("sql"=>'action_finalclass', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("webhook_url", array("sql"=>'webhook_url', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeText("headers", array("sql"=>'headers', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeText("payload", array("sql"=>'payload', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLongText("response", array("sql"=>'response', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class MenuCreation_combodo_webhook_integration extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['Webhook'] = new DashboardMenuNode('Webhook', __DIR__.'/webhook_dashboard.xml', $__comp_menus__['Integrations']->GetIndex(), 120 , 'RemoteApplicationConnection', UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
	}
