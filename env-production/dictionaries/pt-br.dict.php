...
Dict::SetEntries('PT BR', array(
	...
	'Core:AttributeDashboard' => 'Painel do SolidLines Ticketing System',
	...
	'Core:AttributeTemplateString+' => 'String de uma linha, contendo espaços reservados para dados do SolidLines Ticketing System',
	'Core:AttributeTemplateText' => 'Texto do modelo',
	'Core:AttributeTemplateText+' => 'Texto contendo espaços reservados para dados do SolidLines Ticketing System',
	'Core:AttributeTemplateHTML' => 'HTML do modelo',
	'Core:AttributeTemplateHTML+' => 'Código HTML contendo espaços reservados para dados do SolidLines Ticketing System',
...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hiperlink de uma pequena imagem representando o aplicativo com o qual o SolidLines Ticketing System é sincronizado',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hiperlink de aplicativo',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hiperlink para o objeto na aplicação externa com a qual o SolidLines Ticketing System é sincronizado (se aplicável). As substituições possíveis: $this->attribute$ e $replica->primary_key$',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:User/Attribute:login+' => 'Login de acesso ao SolidLines Ticketing System',
	...
	'Class:UserInternal+' => 'Usuário definido dentro do SolidLines Ticketing System',
	...
	'Menu:WelcomeMenu' => 'Página inicial do SolidLines Ticketing System',
	'Menu:WelcomeMenu+' => 'Bem-vindo ao SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => 'Página inicial do SolidLines Ticketing System',
	'Menu:WelcomeMenuPage+' => 'Bem-vindo ao SolidLines Ticketing System',
	...
	'BooleanLabel:no' => 'Não',
	'UI:Login:Title' => 'Login no SolidLines Ticketing System',
	'UI:WelcomeMenu:Title' => 'Bem-vindo ao SolidLines Ticketing System',
	...
	'UI:Error:UploadedFileTooBig' => 'O arquivo a ser carregado é muito grande (Tamanho máximo permitido é de %1$s). Para modificar esse limite, contate o administrador do SolidLines Ticketing System (Verifique a configuração do PHP para upload_max_filesize e post_max_size no servidor)',
	...
	'UI:Login:Welcome' => 'Bem-vindo ao SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'O SolidLines Ticketing System pode enviar um e-mail em que você vai encontrar instruções para seguir para redefinir sua conta',
	...
	'UI:ResetPwd-Error-NoEmailAtt' => 'A conta não está associada a uma pessoa que contém um endereço de e-mail no SolidLines Ticketing System.Por favor, contate o administrador',
	...
	'UI:ResetPwd-EmailBody' => '<body><p>Você solicitou a alteração da senha do SolidLines Ticketing System.</p><p>Por favor, siga este link (passo simples) para <a href="%1$s">digitar a nova senha</a></p>.',
	...
	'UI:AccessRO-Users' => 'SolidLines Ticketing System é somente leitura para usuários finais',
	...
	'UI:CSVExport:LostChars+' => 'O arquivo baixado será codificado em %1$s. O SolidLines Ticketing System detectou alguns caracteres que não são compatíveis com este formato. Esses caracteres serão substituídos por um substituto (por exemplo, caracteres acentuados perdendo o acento) ou serão descartados. Você pode copiar/colar os dados do seu navegador da web. Como alternativa, você pode entrar em contato com seu administrador para alterar a codificação (consulte o parâmetro \'csv_file_default_charset\' do arquivo de configuração do SolidLines Ticketing System)',
	...
	'UI:WelcomeToITop' => 'Bem-vindo ao SolidLines Ticketing System',
...
Quando associada a um gatilho, cada ação recebe um número de "ordem", especificando em qual ordem as ações devem ser executadas.</p>',
	...
	'UI:AutoApplyConfirmationMessage' => 'Algumas alterações ainda não foram aplicadas. Você quer que o SolidLines Ticketing System os leve em consideração?',
...
<tr><td>s</td><td>segundos (2 dígitos, ex. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'Sobre o SolidLines Ticketing System...',
	'UI:About:Title' => 'Sobre o SolidLines Ticketing System',
	...
	'portal:legacy_portal' => 'Portal do usuário (legado) do SolidLines Ticketing System',
	'portal:backoffice' => 'Interface de usuário back-office do SolidLines Ticketing System',
	...
	'UI:Component:GlobalSearch:Tooltip' => 'Pesquisar em todo o SolidLines Ticketing System',
	...
	'UI:ErrorPage:KittyDisclaimer' => 'Nenhum gatinho foi ferido durante a confecção deste GIF e lançamento de versão do SolidLines Ticketing System.
...
ou entre em contato com o seu administrador do SolidLines Ticketing System pois o servidor pode estar sem espaço de armazenamento',
	...
	'bkp-mysqldump-notfound' => 'mysqldump não foi encontrado: %1$s - Por favor, verifique se ele está instalado e no caminho, ou edite o arquivo de configuração do SolidLines Ticketing System para ajustar o parâmetro mysql_bindir',
	'bkp-mysqldump-issue' => 'falha durante a execução do mysqldump (retcode=%1$d): Por favor, certifique-se de que o mysqldump está instalado e o caminho está correto, ou edite o arquivo de configuração do SolidLines Ticketing System para ajustar o parâmetro mysql_bindir',
	...
	'bkp-next-to-delete' => 'Será deletado quando ocorrer o próximo backup (consulte o parâmetro "retention_count" do arquivo de configuração do SolidLines Ticketing System)',
	...
	'Page:DefaultTitle' => 'SolidLines Ticketing System - Portal do Usuário',
	...
	'Brick:Portal:AggregatePage:DefaultTitle' => 'Painel do SolidLines Ticketing System',
	...
	'Organization:Overview:Users' => 'Usuários do SolidLines Ticketing System associados à esta organização',
...
Rather base your condition on \'Drop-down list\' or \'Read-only\' template field types',
	...
	'iTopUpdate:UI:PageTitle' => 'Atualização do SolidLines Ticketing System',
	'itop-core-update:UI:SelectUpdateFile' => 'Atualização do SolidLines Ticketing System',
	'itop-core-update:UI:ConfirmUpdate' => 'Atualização do SolidLines Ticketing System',
	'itop-core-update:UI:UpdateCoreFiles' => 'Atualização do SolidLines Ticketing System',
	'iTopUpdate:UI:MaintenanceModeActive' => 'O SolidLines Ticketing System encontra-se em manutenção, nenhum usuário pode acessar a aplicação. Você precisa rodar o Setup ou restaurar os arquivos da aplicação para voltar ao modo normal',
	'itop-core-update:UI:UpdateDone' => 'Atualização do SolidLines Ticketing System',
	'itop-core-update/Operation:SelectUpdateFile/Title' => 'Atualização do SolidLines Ticketing System',
	'itop-core-update/Operation:ConfirmUpdate/Title' => 'Confirmar Atualização do SolidLines Ticketing System',
	'itop-core-update/Operation:UpdateCoreFiles/Title' => 'Aplicação em Atualização',
	'itop-core-update/Operation:UpdateDone/Title' => 'Atualização do SolidLines Ticketing System finalizada',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'Espaço em disco do SolidLines Ticketing System',
	...
	'Menu:iTopUpdate' => 'Atualização do SolidLines Ticketing System',
	'Menu:iTopUpdate+' => 'Atualização do SolidLines Ticketing System',
	...
	'Menu:iTopHub:Register+' => 'Vá para o iTop Hub para atualizar sua instância SolidLines Ticketing System',
	'Menu:iTopHub:Register:Description' => '<p>Obtenha acesso à sua plataforma da comunidade iTop Hub!</br>Encontre todos os conteúdos e informações necessárias, gerencie suas instâncias SolidLines Ticketing System por meio de ferramentas personalizadas & instale mais extensões.</br><br/>Ao conectar-se ao iTop hub a partir desta página, você enviará informações da sua instância SolidLines Ticketing System ao iTop Hub.</p>',
	'Menu:iTopHub:MyExtensions' => 'Extensões Implantadas',
	'Menu:iTopHub:MyExtensions+' => 'Veja a lista de extensões implantadas nesta instância do SolidLines Ticketing System',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Visite a loja do iTop Hub, seu único lugar para encontrar extensões maravilhosas do SolidLines Ticketing System !</br>Encontre as extensões que irão ajudá-lo a personalizar e adaptar o SolidLines Ticketing System aos seus processos.</br><br/>Ao conectar-se ao iTop hub a partir desta página, você enviará informações da sua instância SolidLines Ticketing System ao iTop Hub.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Erro detectado durante a implantação!<br/>A configuração do SolidLines Ticketing System NÃO foi modificada',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'As seguintes extensões foram implantadas copiando-as manualmente no diretório %1$s do SolidLines Ticketing System:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Acesse o iTop Hub para encontrar as extensões que ajudarão você a personalizar e adaptar o SolidLines Ticketing System aos seus processos !',
	'iTopHub:ExtensionNotInstalled' => 'Não instalado',
	'iTopHub:GetMoreExtensions' => 'Obter extensões do iTop Hub...',
	'iTopHub:LandingWelcome' => 'Parabéns! As extensões a seguir foram baixadas do iTop Hub e implantadas no seu SolidLines Ticketing System',
	'iTopHub:GoBackToITopBtn' => 'Voltar para o SolidLines Ticketing System',
	...
	'iTopHub:DBBackupSentence' => 'Faça um backup do banco de dados e configuração do SolidLines Ticketing System antes de atualizar',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Backup da instância do SolidLines Ticketing System...',
