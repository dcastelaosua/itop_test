...
- Andernfalls wird das kompakte Anwendung-Logo verwendet',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Eine Synchro-Datenquelle kann nur eine SolidLines Ticketing System-Klasse befüllen.',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Ein (kleines) Bild verlinken, das die Applikation repräsentiert, mit der SolidLines Ticketing System synchronisiert wird',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hyperlink zur Applikation',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hyperlink zum SolidLines Ticketing System Objekt in der externen Applikation mit der SolidLines Ticketing System synchronisiert wird (falls anwendbar). Mögliche Platzhalter: $this->attribute$ und $replica->primary_key$',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => 'Abgleichsvorgehen',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Attribute benutzen": Das SolidLines Ticketing System-Objekt stimmt mit den Werten der Replica für jedes Synchro-Attribut überein, das für den Abgleich gekennzeichnet ist.
"Feld primary_key benutzen": Die Spalte primary_key des Replicas soll den Bezeichner des SolidLines Ticketing System-Objekts enthalten.',
...
"Ignorieren": Nichts tun, das zugehörige Objekt verbleibt unverändert in SolidLines Ticketing System.
"Löschen": Löschen des zugehörigen Objekts in SolidLines Ticketing System (und der Replica in der Datentabelle).
...
"Update, danach Löschen": Die "Update-Regeln" anwenden. Wenn die Aufbewahrungsdauer abgelaufen ist, "Löschen" durchführen.',
	...
	'Class:User/Attribute:login+' => 'Der Benutzer-Anmeldename muss innerhalb von SolidLines Ticketing System eindeutig sein',
	...
	'Class:UserInternal+' => 'Benutzer, der innerhalb von SolidLines Ticketing System definiert wird',
	...
	'Menu:WelcomeMenu+' => 'Willkommen bei SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => 'Willkommen',
	'Menu:WelcomeMenuPage+' => 'Willkommen bei SolidLines Ticketing System',
	...
	'UI:WelcomeMenu:Title' => 'Willkommen bei SolidLines Ticketing System',
	...
	'UI:Login:Welcome' => 'Willkommen bei SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System kann Ihnen eine Mail mit Anweisungen senden, wie Sie Ihren Account/Passwort zurücksetzen können',
	...
	'UI:ResetPwd-EmailSubject' => 'Zurücksetzen Ihres SolidLines Ticketing System-Passworts',
	'UI:ResetPwd-EmailBody' => '<body><p>Sie haben das Zurücksetzen Ihres SolidLines Ticketing System Passworts angefordert.</p><p>Bitte folgen Sie diesem Link (funktioniert nur einmalig) : <a href="%1$s">neues Passwort eingeben</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Vielen Dank dafür, dass Sie SolidLines Ticketing System benutzen!',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System ist nur lesbar',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System ist nur lesbar für Endnutzer',
	...
	'UI:Button:Login' => 'in SolidLines Ticketing System anmelden',
	'UI:Login:Error:AccessRestricted' => 'Der SolidLines Ticketing System-Zugang ist gesperrt. Bitte kontaktieren Sie Ihren SolidLines Ticketing System-Administrator.',
	'UI:Login:Error:AccessAdmin' => 'Zugang nur für Personen mit Administratorrechten. Bitte kontaktieren Sie Ihren SolidLines Ticketing System-Administrator.',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - Massenimport',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - universelle Suche',
	...
	'UI:Audit:Title' => 'SolidLines Ticketing System - CMDB-Audit',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - OQL-Abfrage-Auswertung',
	...
	'UI:Query:UrlV1' => 'Die Liste der Felder wurde nicht spezifiziert. Die Seite <em>export-V2.php</em> kann ohne diese Angabe nicht verarbeitet werden. Deswegen, zeigt die nachstehende URL zu der Legacy-Page: <em>export.php</em>. Diese Legacy-Version des Exports hat folgende Limitierungen: Die Liste exportierter Felder kann, abhängig vom Output-Format und vom Datenmodell von SolidLines Ticketing System, variieren. Möchten Sie garantieren, dass die Liste aller exportierten Spalten stabil bleibt, müssen Sie einen Wert für das Attribut Feld angeben und die Seite <em>export-V2.php</em> nutzen.',
	'UI:Schema:Title' => 'SolidLines Ticketing System Objekte-Schema',
	...
	'UI:WelcomeToITop' => 'Willkommen bei SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$s Details',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - Fehler',
	'UI:ObjectDoesNotExist' => 'Leider existiert dieses Objekt nicht oder Sie sind nicht berechtigt es einzusehen.',
	'UI:ObjectArchived' => 'Dieses Objekt wurde archiviert. Bitte aktivieren Sie die Archiv-Modus oder kontaktieren Sie Ihren SolidLines Ticketing System-Administrator.',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Suchergebnisse',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s Änderungen',
	'UI:ModificationTitle_Class_Object' => 'Änderungen von %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - Dupliziere %1$s - %2$s Änderung',
	'UI:CloneTitle_Class_Object' => 'Duplizieren von %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - Erstellung eines neuen Objekts vom Typ "%1$s" ',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Massenlöschung von Objekten',
	'UI:BulkDeleteTitle' => 'Wählen Sie die Objekte aus, die Sie löschen möchten:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System-Objekt wurde erstellt.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Fataler Fehler',
	...
	'UI:FatalErrorMessage' => 'Fataler Fehler! SolidLines Ticketing System kann leider nicht fortfahren.',
	'UI:Error_Details' => 'Fehler: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System Benutzerverwaltung - Profilabbildung',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>In SolidLines Ticketing System sind Benachrichtigungen vollständig anpassbar. Sie basieren auf zwei Gruppen an Objekten: <i>Trigger und Aktionen</i>.</p>
...
Wenn Aktionen mit Trigger verknüpft sind, bekommt jede Aktion eine Auftragsnummer, die die Reihenfolge der auszuführenden Aktionen festlegt.</p>',
	...
	'Portal:Title' => 'SolidLines Ticketing System-Benutzerportal',
	'Portal:NoRequestMgmt' => 'Lieber %1$s, Sie wurden hierher umgeleitet, weil Ihr Account mit dem Profil \'Portal user\' konfiguriert wurde. Leider wurde in SolidLines Ticketing System aber das \'Request Management\'-Feature nicht installiert. Bitte kontaktieren Sie Ihren Administrator.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Einige Änderungen wurden noch nicht angewandt. Möchten Sie, dass SolidLines Ticketing System diese berücksichtigt?',
...
<tr><td>s</td><td>Sekunden (2 Ziffern, z.B. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'Über SolidLines Ticketing System...',
	'UI:About:Title' => 'Über SolidLines Ticketing System',
	...
	'portal:backoffice' => 'SolidLines Ticketing System Backend',
...
- Das Entwicklungsteam',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Willkommen bei SolidLines Ticketing System 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Herzlichen Glückwunsch, Sie sind auf SolidLines Ticketing System Fullmoon gelandet!</div>
<br>
<div>Wir freuen uns, diese neue Version anzukündigen.</div>
<div>Neben der Einführung neuer Funktionen wie dem Newsroom enthält SolidLines Ticketing System 3.2 wichtige Sicherheitsupdates, verbesserte Barrierefreiheit und andere bedeutende Verbesserungen, die auf Stabilität und Sicherheit abzielen.</div>
<br>
<div>Entdecken Sie alle neuen Funktionen von SolidLines Ticketing System und bleiben Sie mit unserem neuen Willkommens-Popup über wichtige Benachrichtigungen auf dem Laufenden!</div>
...
<br>
<div>Passen Sie Ihre SolidLines Ticketing System Präferenzen an, um ein personalisiertes Erlebnis zu erhalten.</div>',
	'UI:WelcomePopup:Message:320_02_Newsroom:Title' => 'Sagen Sie "Hallo" zum Newsroom',
	'UI:WelcomePopup:Message:320_02_Newsroom:Description' => '<div>Sagen Sie Auf Wiedersehen zu überfüllten Posteingängen und Hallo zu personalisierten Benachrichtigungen mit dem <b>Newsroom von SolidLines Ticketing System</b>!</div>
...
<br>
<div>Probieren Sie es noch heute aus und optimieren Sie die Benachrichtigungserfahrung von SolidLines Ticketing System!</div>',
...
<div>Zugriff auf Ihr <a href="%1$s" target="_blank">Benachrichtigungszentrum</a> über den Newsroom oder über Ihre Präferenzen und vermeiden Sie Informationsüberflutung auf allen Ihren Kommunikationskanälen!</div>',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Title' => 'Barrierefreiheit für die Benutzeroberfläche von SolidLines Ticketing System',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Description' => '<div>Um die Barrierefreiheit von SolidLines Ticketing System zu gewährleisten, hat unser Team an <a href="%1$s" target="_blank">neuen Back-Office-Themen</a> gearbeitet. WCAG-konform konzentrieren sich diese Benutzeroberflächen darauf, es Benutzern mit Sehbehinderungen zu erleichtern, die Lösung zu verwenden:
<ul>
	...
	'UI:WelcomePopup:Message:320_04_PowerfulNotifications_AdminOnly:Description' => '<div>Der Newsroom von SolidLines Ticketing System bietet Ihnen eine neue Möglichkeit, Ihre Benachrichtigungen basierend auf wiederkehrenden Ereignissen zu <b>automatisieren</b>, sodass Sie leicht Regeln einrichten können, die für Sie funktionieren.</div>
...
<div>Konfigurieren Sie es noch heute und sehen Sie, wie viel effizienter Ihr Benachrichtigungsprozess sein kann!</div>',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Your SolidLines Ticketing System news',
	...
	'Class:UserExternal+' => 'Extern authentifizierter SolidLines Ticketing System-Benutzer',
	...
	'Class:UserLocal' => 'SolidLines Ticketing System-Benutzer',
	'Class:UserLocal+' => 'Benutzer, der von SolidLines Ticketing System authentifiziert wird',
...
oder melden Sie dem SolidLines Ticketing System Administrator diesen Fehler, weil eventuell kein ausreichender Speicherplatz zur Verfügung steht',
	...
	'config-edit-intro' => 'Achtung: Eine falsche Konfiguration kann dazu führen, dass SolidLines Ticketing System für alle Benutzer unbenutzbar ist!',
	...
	'config-not-allowed-in-demo' => 'Entschuldigung, SolidLines Ticketing System befindet sich im <b>Demo-Modus</b>: Die Konfigurationsdatei kann nicht bearbeitet werden.',
	'config-interactive-not-allowed' => 'Die interaktive Bearbeitung der SolidLines Ticketing System Konfiguration wurde deaktiviert. Siehe <code>\'config_editor\' => \'disabled\'</code> in der Konfigurationsdatei.',
	...
	'Organization:Overview:Users' => 'SolidLines Ticketing System Benutzer innerhalb dieser Organisation',
	...
	'combodo-my-account/Operation:MainPage/Title' => 'Mein Account',
	...
	'itop-core-update:UI:UpdateCoreFiles' => 'Upgrade der SolidLines Ticketing System-Core-Dateien',
	...
	'iTopUpdate:UI:Setup' => 'SolidLines Ticketing System Setup',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'SolidLines Ticketing System Speicherplatz',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Starte SolidLines Ticketing System Setup',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Hiermit wird der SolidLines Ticketing System Setup, sind Sie sicher?',
	...
	'iTopUpdate:Error:BadFileContent' => 'Die Upgradedatei ist kein SolidLines Ticketing System-Paket',
	'iTopUpdate:Error:BadItopProduct' => 'Die Upgradedatei ist nicht mit dieser SolidLines Ticketing System-Version kompatibel.',
	...
	'Menu:iTopHub:Register+' => 'SolidLines Ticketing System-Instanzen über den iTop Hub updaten',
	'Menu:iTopHub:Register:Description' => '<p>Zugriff auf die Community-Plattform iTop Hub!<br>Hier finden sie Informationen zu ihren SolidLines Ticketing System Instanzen, können diese mit personalisierten Tools verwalten und sich Erweiterungen installieren.<br><br>Durch die Verbindung mit dem iTop Hub, werden Informationen zu Ihrer SolidLines Ticketing System Instanz zum iTop Hub übertragen.</p>',
	'Menu:iTopHub:MyExtensions' => 'Installierte Erweiterungen',
	'Menu:iTopHub:MyExtensions+' => 'Liste der auf ihrer SolidLines Ticketing System Instanz installierten Erweiterungen',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Zugriff auf die Community-Plattform iTop Hub!<br>Hier finden sie Informationen zu ihren SolidLines Ticketing System Instanzen, können diese mit personalisierten Tools verwalten und sich Erweiterungen installieren.<br><br>Durch die Verbindung mit dem iTop Hub, werden Informationen zu Ihrer SolidLines Ticketing System Instanz zum iTop Hub übertragen.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Fehler während der Installation!<br>SolidLines Ticketing System Konfiguration wurde NICHT angepasst.',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Besuchen Sie den iTop Hub, um Erweiterungen zu finden, die Ihnen helfen, Ihr SolidLines Ticketing System so zu erweitern, dass es besser zu Ihren Bedürfnissen passt!',
	...
	'iTopHub:GoBackToITopBtn' => 'Gehe zurück zu SolidLines Ticketing System',
	...
	'iTopHub:DBBackupLabel' => 'Backup der SolidLines Ticketing System-Instanz',
	'iTopHub:DBBackupSentence' => 'Vor dem Update ein Backup der iTop Datenbank und der SolidLines Ticketing System Konfiguration durchführen.',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Backup der SolidLines Ticketing System-Instanz...',
...
Löschen Sie das Feld, um den Standardwert neu zu berechnen.',
	...
	'Class:PersonalToken+' => 'Persönliches Token für den Zugriff SolidLines Ticketing System Webdienste, Import, Export, REST und Datensynchronisation',
	...
	'Class:UserToken+' => 'Benutzer für den Zugriff auf Remote-Anwendungen SolidLines Ticketing System Webdienste',
	...
	'MyAccount:UserInfo:Tab:Title' => 'Meine Benutzerinformationen',
...
WICHTIG: Wenn dies gesetzt ist, wird das Attribut \'Nachricht\' ignoriert.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Fügen Sie einen Button unter der Nachricht ein, um das Objekt in SolidLines Ticketing System zu löschen',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Fügen Sie einen Button unter der Nachricht ein, um das Objekt in SolidLines Ticketing System zu bearbeiten',
...
WICHTIG: Wenn dies gesetzt ist, werden das Attribut \'Nachricht\' sowie alle \'Bot-Informationen\' ignoriert.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Fügen Sie einen Button unter der Nachricht ein, um das Objekt in SolidLines Ticketing System zu löschen',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Fügen Sie einen Button unter der Nachricht ein, um das Objekt in SolidLines Ticketing System zu bearbeiten',
