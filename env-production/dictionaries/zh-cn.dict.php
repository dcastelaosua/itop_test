...
- $current_contact->attribute$ 触发通知的用户的属性',
	...
	'Class:ActionNewsroom' => 'SolidLines Ticketing System通知',
...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => '一个同步数据源仅能填充一个 SolidLines Ticketing System 类型',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => '一个 (小) 图片的链接用以表示与 SolidLines Ticketing System 同步的应用.
该图标展示在 SolidLines Ticketing System 同步对象的 "锁定" 符号的提示框中',
	'Class:SynchroDataSource/Attribute:url_application' => '应用的超链接',
	'Class:SynchroDataSource/Attribute:url_application+' => '外部程序中对象的超链接, 对应SolidLines Ticketing System的同步对象. 
可能的占位符: $this->attribute$ 和 $replica->primary_key$.
该图标展示在SolidLines Ticketing System同步对象的 "锁定" 符号的提示框中',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => '一致性原则',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"使用属性": 对标记为复制的SolidLines Ticketing System对象匹配复制每一个同步的属性值.
"使用主键": 复制的字段主键应包含SolidLines Ticketing System对象的唯一标识',
...
审计域通常对应负责检查和修复错误的人',
	...
	'Class:UserInternal+' => 'SolidLines Ticketing System内部定义的用户',
	...
	'Menu:WelcomeMenu' => '欢迎',
	'Menu:WelcomeMenu+' => '欢迎使用SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => '欢迎',
	'Menu:WelcomeMenuPage+' => '欢迎使用SolidLines Ticketing System',
	'Menu:AdminTools' => '管理',
	...
	'BooleanLabel:yes' => '是',
	'BooleanLabel:no' => '否',
	'UI:Login:Title' => 'SolidLines Ticketing System登录',
	'UI:WelcomeMenu:Title' => '欢迎使用SolidLines Ticketing System',
	...
	'UI:SelectOne' => '-- 请选择 --',
	'UI:Login:Welcome' => '欢迎使用SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System将会给您发送一封密码重置邮件.',
	...
	'UI:ResetPwd-EmailSubject' => '重置SolidLines Ticketing System密码',
	'UI:ResetPwd-EmailBody' => '<body><p>您已请求重置SolidLines Ticketing System密码.</p><p>请点击这个链接 (一次性) <a href="%1$s">来输入新的密码</a></p>.',
	...
	'UI:Login:About' => 'SolidLines Ticketing System由 Combodo 创建',
	...
	'UI:LogOffMenu' => '注销',
	'UI:LogOff:ThankYou' => '感谢使用SolidLines Ticketing System',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System是只读的',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System对于终端用户是只读的',
	'UI:ApplicationEnvironment' => '应用环境: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => '新密码输入不一致!',
	'UI:Button:Login' => '登录SolidLines Ticketing System',
	'UI:Login:Error:AccessRestricted' => 'SolidLines Ticketing System访问被限制. 请联系管理员.',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - 批量导入',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - 全局搜索',
	...
	'UI:Audit:Title' => 'SolidLines Ticketing System - CMDB审计',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - OQL查询评估',
	...
	'UI:Query:UrlV1' => '没有定义字段列表. 没有这个信息页面<em>export-V2.php</em>无法调用. 因此, 建议的以下 URL 指向传统页面: <em>export.php</em>. 该传统版本导出具有以下限制: 导出的字段列表很大程度依赖于导出格式和SolidLines Ticketing System数据模型. <br/>如果您需要确保导出的列保持长期稳定, 则必须为属性 "Fields" 指定值并使用页面<em>export-V2.php</em>.',
	'UI:Schema:Title' => 'SolidLines Ticketing System对象模型',
	...
	'UI:WelcomeToITop' => '欢迎使用SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$s 详细内容',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - 错误',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - 搜索结果',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s 修改',
	'UI:ModificationTitle_Class_Object' => '修改 %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - 克隆 %1$s - %2$s 修改',
	'UI:CloneTitle_Class_Object' => '克隆 %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - 新建 %1$s',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - 批量删除',
	'UI:BulkDeleteTitle' => '选择您要删除的对象:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System 对象已创建.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - 致命错误',
	'UI:SystemIntrusion' => '访问被禁止. 您正尝试未被许可的操作.',
	'UI:FatalErrorMessage' => '致命错误, SolidLines Ticketing System无法继续.',
	'UI:Error_Details' => '错误: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System用户管理 - 角色映射',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>在SolidLines Ticketing System中, 通知可以被自定义. 它们是基于两个对象集: <i>触发器和操作</i>.</p>
<p><i><b>触发器</b></i>定义了什么时候发送通知. SolidLines Ticketing System内核自带一些触发器, 另一些触发器可由扩展提供:
<ol>
...
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>',
	...
	'Portal:Title' => 'SolidLines Ticketing System 用户门户',
...
<tr><td>s</td><td>秒 (2位数, 比如 00..59)</td></tr>
	...
	'UI:AboutBox' => '关于SolidLines Ticketing System...',
	'UI:About:Title' => '关于SolidLines Ticketing System',
	...
	'portal:backoffice' => 'SolidLines Ticketing System后台用户界面',
	...
	'Menu:UserManagementMenu+' => '谁可以访问SolidLines Ticketing System以及可以做什么?',
	'Menu:ProfilesMenu' => '角色',
	'Menu:ProfilesMenu+' => '查看已有的角色',
	'Menu:ProfilesMenu:Title' => '角色',
	'Menu:UserAccountsMenu' => '用户账号',
	'Menu:UserAccountsMenu+' => '处理 SolidLines Ticketing System 用户及权限',
...
- 研发团队',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => '欢迎使用 SolidLines Ticketing System 3.2',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'Class:UserExternal+' => '用户在SolidLines Ticketing System外部验证身份',
	...
	'Class:UserLocal' => 'SolidLines Ticketing System 用户',
	'Class:UserLocal+' => '用户由SolidLines Ticketing System验证身份',
...
可能是因为您发送的是空文件,
或者咨询 SolidLines Ticketing System 管理员,检查 SolidLines Ticketing System 服务器硬盘是否满了.',
	...
	'bkp-mysqldump-notfound' => 'mysqldump找不到: %1$s - 请确认它安装在正确的路径, 或者调整SolidLines Ticketing System配置文件的参数mysql_bindir.',
	'bkp-mysqldump-issue' => 'mysqldump无法运行 (retcode=%1$d): 请确认它安装在正确的路径, 或者调整SolidLines Ticketing System配置文件的参数mysql_bindir',
	...
	'config-not-allowed-in-demo' => '抱歉, SolidLines Ticketing System处于<b>演示模式</b>: 不能编辑配置文件.',
	'config-interactive-not-allowed' => 'SolidLines Ticketing System交互式配置编辑器已禁用. 请在配置文件中查看 <code>\'config_editor\' => \'disabled\'</code>.',
	...
	'object-copier:error:preset' => '预调此待创建对象时产生了错误: %1$s. 请联系管理员.',
	'object-copier:error:retrofit' => '向此源对象回传更新信息时产生了错误: %1$s. 请联系管理员.',
	'object-copier:form_label:default' => '正在克隆%1$s',
	'object-copier:menu_label:default' => '克隆...',
	'object-copier:report_label:default' => '克隆于%1$s',
	...
	'Organization:Overview:Users' => '此组织里所有的SolidLines Ticketing System用户',
	'Class:Location' => '地点',
...
If using OQL, objects proposed are limited to User rights. User Portal scopes are not applied.',
	...
	'iTopUpdate:UI:Setup' => 'SolidLines Ticketing System安装',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'SolidLines Ticketing System的磁盘空间',
	...
	'iTopUpdate:UI:SetupLaunch' => '启动SolidLines Ticketing System安装',
	'iTopUpdate:UI:SetupLaunchConfirm' => '将启动SolidLines Ticketing System安装, 确定吗?',
	...
	'iTopHub:GoBackToITopBtn' => '返回SolidLines Ticketing System',
	'iTopHub:Uncompressing' => '扩展解压中...',
	'iTopHub:InstallationWelcome' => '安装来自 iTop Hub 的扩展',
	'iTopHub:DBBackupLabel' => '本机备份',
	'iTopHub:DBBackupSentence' => '在升级之前,备份数据库和SolidLines Ticketing System配置文件',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'SolidLines Ticketing System实例备份...',
...
Erase the field to recalculate default value',
	...
	'UI:SynchroDashboard:Title' => '数据同步仪表盘',
	'UI:SynchroDashboard:StartDate' => '开始日期',
	'UI:SynchroDashboard:StartDate+' => '最近一次运行的开始日期',
	'UI:SynchroDashboard:Duration' => '持续时间',
	'UI:SynchroDashboard:Duration+' => '最近一次运行的持续时间',
	'UI:SynchroDashboard:NbOfReplicas' => '复制数量',
	'UI:SynchroDashboard:NbOfReplicas+' => '此同步数据源的复制总数量',
	'UI:SynchroDashboard:NbOfErrors' => '错误',
	'UI:SynchroDashboard:NbOfErrors+' => '最近一次运行时的错误数',
	'UI:SynchroDashboard:NbOfWarnings' => '告警',
	'UI:SynchroDashboard:NbOfWarnings+' => '最近一次运行时的告警数',
	'UI:SynchroDashboard:PeakMemoryUsage' => '内存使用峰值',
	'UI:SynchroDashboard:PeakMemoryUsage+' => '同步时最大使用的内存数',
	'UI:SynchroDashboard:Overview:LatestRun' => '最近运行',
	'UI:SynchroDashboard:Overview:DataSources' => '数据源',
	'UI:SynchroDashboard:Overview:RunTime' => '运行时长',
	'UI:SynchroDashboard:Overview:Replicas' => '复制',
	'UI:SynchroDashboard:Overview:Errors' => '错误',
	'UI:SynchroDashboard:Overview:Warnings' => '告警',
	'UI:SynchroDashboard:Overview:PeakMemory' => '内存峰值',
	'Menu:DataSourcesDashboard' => '同步仪表盘',
...
请注意：如果设置了此参数，则会忽略“消息”参数。',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => '在此消息之后包含一个按钮，以在SolidLines Ticketing System中删除此对象',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => '在此消息之后包含一个按钮，以在SolidLines Ticketing System中修改此对象',
...
请注意：如果设置了此参数，则会忽略“消息”和所有的“自动程序信息”参数。',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => '在此消息之后包含一个按钮，以在SolidLines Ticketing System中删除此对象',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => '在此消息之后包含一个按钮，以在SolidLines Ticketing System中修改此对象',
...
——在某些情况下$oResponse可以为空（例如发送请求失败）',
	...
	'Class:ActioniTopWebhook' => 'SolidLines Ticketing Systemwebhook调用',
	'Class:ActioniTopWebhook+' => '远程SolidLines Ticketing System应用的Webhook调用',
	'Class:ActioniTopWebhook/Attribute:headers+' => 'HTTP请求的头信息，每个必须1行（例如：“Content-type: application/x-www-form-urlencoded”）

请注意：
——当应用为SolidLines Ticketing System时“Content-type”必须设置为“application/x-www-form-urlencoded”，即使发送的是JSON
...
请注意：如果设置了此参数，则会忽略“JSON数据”参数。',
	...
	'Class:RemoteiTopConnection' => '远程SolidLines Ticketing System连接',
	'Class:RemoteiTopConnection/Attribute:auth_pwd' => '验证密码',
	'Class:RemoteiTopConnection/Attribute:auth_pwd+' => '此身份验证所使用的用户（远程SolidLines Ticketing System）密码',
	'Class:RemoteiTopConnection/Attribute:auth_user' => '验证用户',
	'Class:RemoteiTopConnection/Attribute:auth_user+' => '此身份验证所使用的用户（远程SolidLines Ticketing System）登录名',
