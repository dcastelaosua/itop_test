...
Het domein komt meestal overeen met wie er verantwoordelijk is om de fouten te controleren en oplossen',
	...
	'Class:UserInternal+' => 'Gebruiker gedefinieerd in SolidLines Ticketing System',
	...
	'Menu:WelcomeMenu+' => 'Welkom in SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => 'Welkom',
	'Menu:WelcomeMenuPage+' => 'Welkom in SolidLines Ticketing System',
	...
	'BooleanLabel:yes' => 'Ja',
	'BooleanLabel:no' => 'Nee',
	'UI:Login:Title' => 'Aanmelden in SolidLines Ticketing System',
	'UI:WelcomeMenu:Title' => 'Welkom in SolidLines Ticketing System',
	...
	'UI:Error:UploadedFileTooBig' => 'Het geüploade bestand is te groot. De maximale grootte is %1$s. Contacteer jouw SolidLines Ticketing System-beheerder om deze limiet aan te passen. (Controleer de PHP-configuratie voor "upload_max_filesize" en "post_max_size" op de server).',
	...
	'UI:Login:Welcome' => 'Welkom in SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System kan je een e-mail sturen waarin de instructies voor het resetten van jouw account staan.',
	...
	'UI:ResetPwd-EmailSubject' => 'Reset jouw SolidLines Ticketing System-wachtwoord',
	'UI:ResetPwd-EmailBody' => '<body><p>Je hebt een reset van jouw SolidLines Ticketing System-wachtwoord aangevraagd.</p><p>Klik op deze link (eenmalig te gebruiken) om <a href="%1$s">een nieuw wachtwoord in te voeren</a></p>.',
	...
	'UI:Login:About' => 'SolidLines Ticketing System',
	...
	'UI:LogOff:ThankYou' => 'Bedankt voor het gebruiken van SolidLines Ticketing System',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System is alleen-lezen',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System is alleen-lezen voor eindgebruikers',
	...
	'UI:Button:Login' => 'Ga naar SolidLines Ticketing System',
	'UI:Login:Error:AccessRestricted' => 'Geen toegang tot SolidLines Ticketing System.Neem contact op met een SolidLines Ticketing System-beheerder.',
	'UI:Login:Error:AccessAdmin' => 'Alleen toegankelijk voor mensen met beheerdersrechten. Neem contact op met een SolidLines Ticketing System-beheerder',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Universele zoekopdracht',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - Evaluatie van OQL-query',
	...
	'UI:Query:UrlV1' => 'De lijst van velden is leeg gelaten. De pagina <em>export-V2.php</em> kan niet aangeroepen worden zonder deze informatie.Daarom verwijst de onderstaande link naar de oude export-pagina: <em>export.php</em>. Deze verouderde versie heeft enkele beperkingen: de lijst van geëxporteerde velden kan verschillen afhankelijk van het gekozen export-formaat en het datamodel van SolidLines Ticketing System.Als je wil dat de lijst van geëxporteerde kolommen hetzelfde blijft over lange tijd, dan moet je een waarde opgeven voor het attribuut "Velden" en de pagina <em>export-V2.php</em> gebruiken.',
	'UI:Schema:Title' => 'SolidLines Ticketing System objecten-schema',
	...
	'UI:WelcomeToITop' => 'Welkom in SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$s details',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - Fout',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Zoekresultaten',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s aanpassing',
	'UI:ModificationTitle_Class_Object' => 'Aanpassen van %1$s: <span class="hilite">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - Kloon %1$s - %2$s aanpassing',
	'UI:CloneTitle_Class_Object' => 'Klonen van %1$s: <span class="hilite">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - %1$s aanmaken',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Meerdere objecten verwijderen',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Fatale Fout',
	'UI:SystemIntrusion' => 'Toegang geweigerd. Je hebt een actie aangevraagd waarvoor je niet gemachtigd bent.',
	'UI:FatalErrorMessage' => 'Fatale fout, SolidLines Ticketing System kan niet doorgaan.',
	'UI:Error_Details' => 'Fout: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System gebruikersbeheer - profiel-projecties',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>In SolidLines Ticketing System zijn de meldingen volledig aan te passen. Ze zijn gebaseerd op twee sets van objecten: <i>triggers and actions</i>.</p>
<p><i><b>Triggers</b></i> bepalen wanneer er een melding is. Er zijn verschillende triggers als onderdeel van SolidLines Ticketing System core, maar andere kunnen door middel van uitbreidingen worden toegevoegd.
...
Bij die koppeling wordt aan elke actie een volgorde-nummer gegeven. Dit bepaalt in welke volgorde de acties moeten worden uitgevoerd.</p>',
	...
	'Portal:Title' => 'SolidLines Ticketing System gebruikersportaal',
	'Portal:NoRequestMgmt' => 'Beste %1$s, je bent naar deze pagina doorverwezen omdat jouw account is geconfigureerd met het profiel "Portal user". Helaas is SolidLines Ticketing System niet geïnstalleerd met de optie "Request Management". Neem contact op met jouw beheerder.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Sommige veranderingen zijn nog niet doorgevoerd. Wil je dat SolidLines Ticketing System deze meeneemt?',
	...
	'UI:DashletUnknown:RenderText:Edit' => 'Kan deze dashlet niet weergeven (klasse "%1$s"). Controleer bij je SolidLines Ticketing System-beheerder of dit nog beschikbaar is.',
	...
	'UI:AboutBox' => 'Over SolidLines Ticketing System...',
	'UI:About:Title' => 'Over SolidLines Ticketing System',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'Class:UserLocal' => 'SolidLines Ticketing System-gebruiker',
	'Class:UserLocal+' => 'Gebruiker die aanmeldt met gegevens aangemaakt in het gebruikersbeheer van SolidLines Ticketing System',
	'Class:UserLocal/Attribute:password' => 'Wachtwoord',
	'Class:UserLocal/Attribute:password+' => 'Het wachtwoord waarmee de gebruiker zich aanmeldt bij SolidLines Ticketing System',
...
of vraag de iTop administrator om de opslagruimte van de iTop-server na te kijken',
	...
	'config-not-allowed-in-demo' => 'Sorry, SolidLines Ticketing System is in <b>demo mode</b>: Het configuratiebestand kan niet aangepast worden.',
	'config-interactive-not-allowed' => 'Interactieve aanpassing van de SolidLines Ticketing System configuratie is uitgeschackeld. Zie <code>\'config_editor\' => \'disabled\'</code> in het configuratiebestand.',
	...
	'Organization:Overview:Users' => 'SolidLines Ticketing System-gebruikers in deze organisatie',
...
If using OQL, objects proposed are limited to User rights. User Portal scopes are not applied.',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'SolidLines Ticketing System schijfgebruik',
	...
	'iTopUpdate:UI:CannotUpdateUseSetup' => '<b>Aangepaste bestanden gedetecteerd</b>, gedeeltelijke update kan niet uitgevoerd worden.</br>Volg de <a target="_blank" href="%2$s">procedure</a> om SolidLines Ticketing System manueel te updaten. Je moet de <a href="%1$s">setup</a> gebruiken om de applicatie te updaten.',
	'iTopUpdate:UI:CheckInProgress' => 'Even geduld terwijl de integriteitscontrole loopt',
	'iTopUpdate:UI:SetupLaunch' => 'Start de SolidLines Ticketing System setup',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Dit zal de SolidLines Ticketing System setup uitvoeren, ben je zeker?',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Er trad een fout op bij de installatie!<br>SolidLines Ticketing System-configuratie werd NIET aangepast.',
	...
	'iTopHub:GoBackToITopBtn' => 'Terug naar SolidLines Ticketing System',
	...
	'iTopHub:DBBackupSentence' => 'Neem vooraf een backup van de database en SolidLines Ticketing System-configuratie vooraleer de update uit te voeren',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Backup SolidLines Ticketing System-omgeving...',
...
BELANGRIJK: Indien geconfigureerd, zal \'bericht\' genegeerd worden.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Voeg een knop toe onder het bericht om het object te verwijderen in SolidLines Ticketing System',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Voeg een knop toe onder het bericht om het object aan te passen in SolidLines Ticketing System',
...
BELANGRIJK: Indien geconfigureerd, zullen \'bericht\' en alle \'bot-informatie\' genegeerd worden.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Voeg een knop toe onder het bericht om het object te verwijderen in SolidLines Ticketing System',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Voeg een knop toe onder het bericht om het object aan te passen in SolidLines Ticketing System',
