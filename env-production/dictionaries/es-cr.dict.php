...
Operadores:<br/>
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Una fuente de datos sincronizada solo puede completar una única clase SolidLines Ticketing System',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'URL a pequeña imagen representando la aplicación con la que SolidLines Ticketing System se sincronizará',
	...
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Utilice los atributos": SolidLines Ticketing System El objeto coincide con los valores de réplica para cada atributo Synchro marcado para reconciliación.
"Usar clave_primaria": se espera que la columna clave_primaria de la réplica contenga el identificador de SolidLines Ticketing System objeto',
...
El dominio suele corresponder a quién se encarga de comprobar y corregir errores.',
	...
	'Class:UserInternal+' => 'Usuario definido en SolidLines Ticketing System',
	...
	'Menu:WelcomeMenu+' => 'Bienvenido a SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => 'Bienvenido',
	'Menu:WelcomeMenuPage+' => 'Bienvenido a SolidLines Ticketing System',
	...
	'UI:WelcomeMenu:Title' => 'Bienvenido a SolidLines Ticketing System',
	...
	'UI:Login:Welcome' => 'Bienvenido a SolidLines Ticketing System',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System puede enviarle un correo en el cual encontrará las instrucciones a seguir para restablecer su contraseña.',
	...
	'UI:ResetPwd-EmailSubject' => 'Restablecer contraseña de SolidLines Ticketing System',
	'UI:ResetPwd-EmailBody' => '<body><p>Ha solicitado restablecer su contraseña en SolidLines Ticketing System.</p><p>Por favor de click en la siguiente liga: <a href="%1$s">proporcione una nueva contraseña</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Gracias por usar SolidLines Ticketing System',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System está en modo de sólo lectura',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System está en modo de sólo lectura para usuarios',
	...
	'UI:Login:Error:AccessRestricted' => 'El acceso a SolidLines Ticketing System está restringido. Por favor contacte al Administrador de SolidLines Ticketing System.',
	'UI:Login:Error:AccessAdmin' => 'Acceso restringido a usuarios con privilegio de administrador. Por favor contacte al Administrador de SolidLines Ticketing System.',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - Importación por Lotes',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Busqueda Universal',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - Evaluación de consultas OQL',
	...
	'UI:WelcomeToITop' => 'Bienvenido a SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - Detalles %2$s',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Resultados de la Búsqueda',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s modificación',
	'UI:ModificationTitle_Class_Object' => 'Modificación de %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - Duplicar %1$s - %2$s modificación',
	'UI:CloneTitle_Class_Object' => 'Duplicado de %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - Creación de %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Eliminar por lote',
	'UI:BulkDeleteTitle' => 'Seleccione los objetos que desea eliminar:',
	'UI:PageTitle:ObjectCreated' => 'Objeto de SolidLines Ticketing System creado.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Error Fatal',
	'UI:SystemIntrusion' => 'Acceso denegado. Esta tratando de ejecutar una operación no permitida para usted.',
	'UI:FatalErrorMessage' => 'Error fatal, SolidLines Ticketing System no puede continuar.',
	'UI:Error_Details' => 'Error: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'Administración de usuarios SolidLines Ticketing System - proyecciones de Perfil',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>En SolidLines Ticketing System las notificaciones son completamente personalizables. Están basadas en dos conjuntos de objetos: <i>Disparadores y Acciones</i>.</p>
...
Cuando se asocien con un disparador, cada acción recibe un número de "orden", esto especifica en que orden se ejecutaran las acciones.</p>',
	...
	'Portal:NoRequestMgmt' => 'Estimado(a) %1$s, ha sido redirigido a esta página porque su cuenta está configurada con el Perfil \'Portal user\'.Desafortunadamente, SolidLines Ticketing System no fue instalado con el módulo \'Request Management\'.Por favor contacte a su Administrador.',
	...
	'Portal:ErrorNoContactForThisUser' => 'Error: el Usuario no está asociado con un Contacto/Persona. Por favor contacte al Administrador de SolidLines Ticketing System',
	...
	'UI:AutoApplyConfirmationMessage' => 'Algunos cambios no han sido aplicados todavía. ¿Quiere que SolidLines Ticketing System los tome en cuenta?',
...
<tr><td>s</td><td>segundos (2 digitos, ejem. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'Acerca de SolidLines Ticketing System...',
	'UI:About:Title' => 'Acerca de SolidLines Ticketing System',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Sus noticias de SolidLines Ticketing System',
	...
	'Class:UserExternal+' => 'Usuario autenticado fuera de SolidLines Ticketing System',
	...
	'Class:UserLocal' => 'Usuario de SolidLines Ticketing System',
	'Class:UserLocal+' => 'Usuario Autenticado vía SolidLines Ticketing System',
...
o pregunte al administador de iTop si el servidor que ha quedado sin espacio en disco.',
	...
	'config-not-allowed-in-demo' => 'Lo sentimos, SolidLines Ticketing System está en <b>modo de demostración</b>: el archivo de configuración no se puede editar.',
	'config-interactive-not-allowed' => 'SolidLines Ticketing System edición interactiva de la configuración como deshabilitada. Consulte <code>\'config_editor\' => \'disabled\'</code> en el archivo de configuración.',
...
Rather base your condition on \'Drop-down list\' or \'Read-only\' template field types',
	...
	'iTopUpdate:UI:Setup' => 'Configuración SolidLines Ticketing System',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'Espacio en disco de SolidLines Ticketing System',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Inicie configuración SolidLines Ticketing System',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Esto iniciará configuración SolidLines Ticketing System, ¿Está seguro?',
	...
	'Menu:iTopHub:Register+' => 'Ir a iTop Hub para actualizar su instancia de SolidLines Ticketing System',
	'Menu:iTopHub:Register:Description' => '<p>Obtenga acceso a la plataforma comunitaria iTop Hub!<br>Encuentre todo el contenido e información que necesite, adminitre sus instancias a través de herramientas personalizadas e instale más extensiones.<br><br>Mediante la conexión al Hub desde esta página, usted compartirá información acerca de esta instancia de SolidLines Ticketing System en el Hub.</p>',
	'Menu:iTopHub:MyExtensions' => 'Extensiones instaladas',
	'Menu:iTopHub:MyExtensions+' => 'Vea la lista de extensiones instalada en esta instancia de SolidLines Ticketing System',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Vea en "iTop Hub’s store", su único lugar para encontrar extensiones de SolidLines Ticketing System.<br>Encuentre aquellas que le ayuden a personalizar y adaptar SolidLines Ticketing System a sus procesos.<br><br>Mediante la conexión al Hub desde esta página, usted compartirá información acerca de esta instancia de SolidLines Ticketing System en el Hub.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Error detectado durante la instalación!<br>La configuración de SolidLines Ticketing System NO fue modificada.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Las siguientes extensiones fueron instaladas copiandolas manualmente en el directorio %1$s de SolidLines Ticketing System:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Navegue en iTop Hub para encontrar aquellas que le ayuden a personalizar y adaptar SolidLines Ticketing System a sus procesos !',
	'iTopHub:ExtensionNotInstalled' => 'No instalada',
	'iTopHub:GetMoreExtensions' => 'Obtener extensiones de iTop Hub...',
	'iTopHub:LandingWelcome' => '¡Felicidades! Las siguientes extensiones fueron descargadas de iTop Hub e instaladas en su SolidLines Ticketing System.',
	'iTopHub:GoBackToITopBtn' => 'Regresar a SolidLines Ticketing System',
	...
	'iTopHub:DBBackupSentence' => 'Realice un respaldo de la base de datos y configuración de SolidLines Ticketing System antes de actualizar.',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Respaldo de Instancia de SolidLines Ticketing System...',
...
Borre el campo para recalcular el valor predeterminado',
	...
	'Class:PersonalToken+' => 'Token Personal para acceder a SolidLines Ticketing System servicios web, importación, exportación, REST y sincronización de datos',
	...
	'Class:UserToken+' => 'Usuario para aplicaciones remotas que acceden a SolidLines Ticketing System servicios web',
...
IMPORTANTE: Si se habilita, el \'mensaje\' será ignorados.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Incluya un botón debajo del mensaje para eliminar el objeto en SolidLines Ticketing System',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Incluir un botón debajo del mensaje para editar el objeto en SolidLines Ticketing System',
...
IMPORTANTE: Si se habilita, el \'mensaje\' y toda la \'información bot\' serán ignorados.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Incluir un botón debajo del mensaje para eliminar el objeto en SolidLines Ticketing System',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Incluir un botón debajo del mensaje para editar el objeto en SolidLines Ticketing System',
...
IMPORTANTE: Si se habilita, el atributo \'JSON data\' será ignorado.',
	...
	'Class:RemoteApplicationType/Attribute:action_explanation+' => 'Explicación sobre cómo configurar una acción webhook en SolidLines Ticketing System (activada por un disparador) para esa aplicación. Por ejemplo, cómo construir una carga o qué esperar en la respuesta.',
