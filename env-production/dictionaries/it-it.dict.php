...
Operatori:<br/>
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Una Fonte dati di sincronizzazione può popolare solo una singola classe SolidLines Ticketing System',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Una (piccola) immagine del collegamento ipertestuale che rappresenta l\'applicazione con cui è sincronizzato SolidLines Ticketing System',
	...
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Utilizza gli attributi": L\'oggetto SolidLines Ticketing System corrisponde ai valori replica per ciascun attributo di sincronizzazione contrassegnato per la Conciliazione.
	"Utilizza la chiave primaria": si prevede che la colonna primary_key della replica contenga l\'identificatore dell\'oggetto SolidLines Ticketing System',
	...
	'Class:UserInternal+' => 'Utente definito all\'interno di SolidLines Ticketing System',
	...
	'UI:WelcomeMenu:Title' => 'Benveuto su SolidLines Ticketing System',
	...
	'UI:Login:Welcome' => 'Benvenuti su SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System può inviarti un\'email contenente le istruzioni da seguire per reimpostare il tuo account.',
	...
	'UI:ResetPwd-EmailSubject' => 'Reimposta la password di SolidLines Ticketing System',
	'UI:ResetPwd-EmailBody' => '<body><p>Hai richiesto di reimpostare la password di SolidLines Ticketing System.</p><p>Segui questo link (uso singolo) per <a href="%1$s">inserire una nuova password</a></p>.',
	...
	'UI:Login:About' => 'SolidLines Ticketing System Sviluppato da Combodo',
	...
	'UI:LogOff:ThankYou' => 'Grazie per aver scelto SolidLines Ticketing System',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System è di sola lettura',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System è di sola lettura per gli utenti finali',
	...
	'UI:Button:Login' => 'Entra in SolidLines Ticketing System',
	'UI:Login:Error:AccessRestricted' => 'L\'accesso a SolidLines Ticketing System è limitato. Si prega di contattare un amministratore SolidLines Ticketing System.',
	'UI:Login:Error:AccessAdmin' => 'Accesso limitato alle persone che hanno privilegi di amministratore. Si prega di contattare un amministratore SolidLines Ticketing System.',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - importazione collettiva',
	'UI:Title:BulkImport+' => '',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Ricerca Universale',
	...
	'UI:CSVExport:LostChars+' => 'Il file scaricato sarà codificato in %1$s. SolidLines Ticketing System ha rilevato alcuni caratteri che non sono compatibili con questo formato. Questi caratteri verranno sostituiti da un sostituto (ad esempio, caratteri accentati che perderanno l\'accento) o verranno eliminati. Puoi copiare/incollare i dati dal tuo browser web. In alternativa, puoi contattare il tuo amministratore per cambiare la codifica (vedi parametro \'csv_file_default_charset\').',
	'UI:Audit:Title' => 'SolidLines Ticketing System - Audit CMDB',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - Valutazione Query OQL',
	...
	'UI:Query:UrlV1' => 'L\'elenco dei campi è stato lasciato non specificato. La pagina <em>export-V2.php</em> non può essere invocata senza queste informazioni. Pertanto, l\'URL suggerito di seguito punta alla pagina legacy: <em>export.php</em>. Questa versione legacy dell\'esportazione ha il seguente limite: l\'elenco dei campi esportati può variare a seconda del formato di output e del modello di dati di SolidLines Ticketing System.Se vuoi garantire che l\'elenco delle colonne esportate rimanga stabile nel lungo periodo, devi specificare un valore per l\'attributo "Campi" e utilizzare la pagina <em>export-V2.php</em>.',
	'UI:Schema:Title' => 'SolidLines Ticketing System schema degli oggetti',
	...
	'UI:WelcomeToITop' => 'Benvenuto su SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$s dettagli',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - Errore',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Risultati della ricerca',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - Modifica %2$s',
	'UI:ModificationTitle_Class_Object' => 'Modifica di %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - Clone %1$s - Modifica %2$s',
	'UI:CloneTitle_Class_Object' => 'Clone di %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - Creazione di un nuovo %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Eliminazione di massa',
	'UI:BulkDeleteTitle' => 'Seleziona gli oggetti che si desidera eliminare:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System Oggetto Creato.',
	...
	'UI:FatalErrorMessage' => 'Fatal error, SolidLines Ticketing System non può continuare.',
	'UI:Error_Details' => 'Errore: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System gestione degli utenti - proiezioni profilo',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>In SolidLines Ticketing System le notifiche sono completamente personalizzabili. Esse si basano su due serie di oggetti: <i>trigger e azioni</i>.</p>
<p><i>I <b>trigger</b></i> definiscono quando verrà eseguita una notifica. Ci sono diversi trigger come parte del nucleo di SolidLines Ticketing System, ma altri possono essere forniti da estensioni:
<ol>
...
Quando è associata a un trigger, a ogni azione è assegnato un numero "ordine", che specifica in quale ordine le azioni devono essere eseguite.</p>',
	...
	'Portal:Title' => 'Portale Utente SolidLines Ticketing System',
	'Portal:NoRequestMgmt' => 'Caro %1$s, sei stato reindirizzato a questa pagina perché il tuo account è configurato con il profilo "Utente del portale". Purtroppo, SolidLines Ticketing System non è stato installato con la funzionalità "Gestione delle richieste". Si prega di contattare l\'amministratore.',
	...
	'UI:AboutBox' => 'Informazioni su SolidLines Ticketing System...',
	'UI:About:Title' => 'Informazioni su SolidLines Ticketing System',
	...
	'portal:backoffice' => 'Interfaccia utente di SolidLines Ticketing System Back-Office',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'Class:UserExternal+' => 'Utente autenticato al di fuori di SolidLines Ticketing System',
	...
	'Class:UserLocal' => 'Utente SolidLines Ticketing System',
	'Class:UserLocal+' => 'Utente autenticato da SolidLines Ticketing System',
	...
	o chiedi al tuo amministratore di SolidLines Ticketing System se il disco del server SolidLines Ticketing System è pieno.',
	...
	'config-not-allowed-in-demo' => 'Spiacente, SolidLines Ticketing System è in <b>modalità dimostrativa</b>: il file di configurazione non può essere modificato.',
	'config-interactive-not-allowed' => 'La modifica interattiva della configurazione di SolidLines Ticketing System è stata disabilitata. Vedere <code>\'config_editor\' => \'disabled\'</code> nel file di configurazione.',
...
If using OQL, objects proposed are limited to User rights. User Portal scopes are not applied.',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'SolidLines Ticketing System spazio su disco',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Avvia SolidLines Ticketing System Setup',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Questo avvierà SolidLines Ticketing System setup, sei sicuro?',
	...
	'Menu:iTopHub:Register+' => 'Vai a iTop Hub per aggiornare la tua istanza di SolidLines Ticketing System',
	'Menu:iTopHub:Register:Description' => '<p>Ottieni accesso alla tua piattaforma comunitaria iTop Hub!</br>Trova tutti i contenuti e le informazioni di cui hai bisogno, gestisci le tue istanze con strumenti personalizzati e installa più estensioni.</br><br/>Connettendoti all\'Hub da questa pagina, invierai informazioni su questa istanza di SolidLines Ticketing System all\'Hub.</p>',
	'Menu:iTopHub:MyExtensions' => 'Estensioni implementate',
	'Menu:iTopHub:MyExtensions+' => 'Vedi l\'elenco delle estensioni implementate su questa istanza di SolidLines Ticketing System',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Dai un\'occhiata allo store di iTop Hub, il tuo posto unico per trovare fantastiche estensioni di SolidLines Ticketing System!</br>Trova quelle che ti aiuteranno a personalizzare e adattare SolidLines Ticketing System ai tuoi processi.</br><br/>Connettendoti all\'Hub da questa pagina, invierai informazioni su questa istanza di SolidLines Ticketing System all\'Hub.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Errore rilevato durante il deployment!<br/>La configurazione di SolidLines Ticketing System NON è stata modificata.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Le seguenti estensioni sono state implementate manualmente copiandole nella directory %1$s di SolidLines Ticketing System:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Cerca su iTop Hub le estensioni che ti aiuteranno a personalizzare e adattare SolidLines Ticketing System ai tuoi processi!',
	'iTopHub:ExtensionNotInstalled' => 'Non installata',
	'iTopHub:GetMoreExtensions' => 'Ottieni estensioni da iTop Hub...',
	'iTopHub:LandingWelcome' => 'Congratulazioni! Le seguenti estensioni sono state scaricate da iTop Hub e implementate nella tua SolidLines Ticketing System.',
	'iTopHub:GoBackToITopBtn' => 'Torna a SolidLines Ticketing System',
	...
	'iTopHub:DBBackupSentence' => 'Esegui un backup del database e della configurazione di SolidLines Ticketing System prima dell\'aggiornamento',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Backup dell\'istanza SolidLines Ticketing System...',
