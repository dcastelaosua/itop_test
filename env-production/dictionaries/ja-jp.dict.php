...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'SolidLines Ticketing Systemが同期されたアプリケーションを示すハイパーリンク（小さな）イメージ',
	'Class:SynchroDataSource/Attribute:url_application' => 'アプリケーションのハイパーリンク',
	'Class:SynchroDataSource/Attribute:url_application+' => 'SolidLines Ticketing Systemが同期化された外部アプリケーションのSolidLines Ticketing Systemオブジェクトへのハイパーリンク（該当する場合）。可能なプレースホルダ: $this->attribute$ and $replica->primary_key$',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Menu:WelcomeMenu+' => 'ようこそ、SolidLines Ticketing Systemへ',
	'Menu:WelcomeMenuPage' => 'ようこそ',
	'Menu:WelcomeMenuPage+' => 'ようこそ、SolidLines Ticketing Systemへ',
	...
	'UI:WelcomeMenu:Title' => 'ようこそ、SolidLines Ticketing Systemへ',
	...
	'UI:Login:Welcome' => 'SolidLines Ticketing Systemへようこそ',
	...
	'UI:LogOffMenu' => 'ログオフ',
	'UI:LogOff:ThankYou' => 'SolidLines Ticketing Systemをご利用いただき、ありがとうございます。',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing Systemは参照専用です。',
	'UI:AccessRO-Users' => 'エンドユーザの方はSolidLines Ticketing Systemは参照専用です。',
	'UI:ApplicationEnvironment' => 'アプリケーション環境: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => '2度入力された新しいパスワードが一致しません!',
	'UI:Button:Login' => 'SolidLines Ticketing Systemへ入る',
	'UI:Login:Error:AccessRestricted' => 'SolidLines Ticketing Systemへのアクセスは制限されています。SolidLines Ticketing System管理者に問い合わせしてください。',
	'UI:Login:Error:AccessAdmin' => '管理者権限をもつユーザにアクセスが制限されています。SolidLines Ticketing System管理者に問い合わせしてください。',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - バルクインポート',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - ユニバーサル検索',
	...
	'UI:Audit:Title' => 'SolidLines Ticketing System - CMDB 監査',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - OQLクエリ評価',
	...
	'UI:Schema:Title' => 'SolidLines Ticketing System オブジェクトスキーマ',
	...
	'UI:WelcomeToITop' => 'SolidLines Ticketing Systemへようこそ',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$sの詳細',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - エラー',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - 検索結果',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s 修正',
	'UI:ModificationTitle_Class_Object' => '%1$sの修正： <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - クローン%1$s - %2$s 修正',
	'UI:CloneTitle_Class_Object' => '%1$sのクローン：<span class=\\"hilite">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - 新規%1$sを作成',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - バルク削除',
	'UI:BulkDeleteTitle' => '削除するオブジェクトを選択してください。',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing Systemオブジェクトが作成されました。',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - 致命的なエラー',
	...
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System ユーザ管理 - プロフィールプロジェクション',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>SolidLines Ticketing Systemでは、通知はすべてカスタマイズが可能です。通知は<i>トリガーとアクション</i>という二つのオブジェクトがベースになっています。
...
トリガーに関連づけられると、各々のアクションは順番が与えられ、どの順序でアクションが実行されるかが指定されます。</p>',
	...
	'Portal:Title' => 'SolidLines Ticketing Systemユーザポータル',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'Class:UserLocal' => 'SolidLines Ticketing Systemユーザー',
	'Class:UserLocal+' => 'SolidLines Ticketing Systemローカル認証ユーザー',
