...
- W przeciwnym razie użyte zostanie kompaktowe logo aplikacji',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Synchroniczne źródło danych może zapełnić tylko jedną klasę SolidLines Ticketing System',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hiperłącze (mały) obraz przedstawiający aplikację, z którą synchronizowany jest SolidLines Ticketing System',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hiperłącze do aplikacji',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hiperłącze do obiektu SolidLines Ticketing System w zewnętrznej aplikacji, z którą SolidLines Ticketing System jest zsynchronizowany (jeśli dotyczy). Możliwe symbole zastępcze: $this->attribute$ i $replica->primary_key$',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => 'Polityka uzgadniania',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Użyj atrybutów": SolidLines Ticketing System obiekt odpowiada wartościom replik dla każdego atrybutu Synchro oznaczonego jako Uzgadnianie.
"Użyj klucza podstawowego": oczekuje się, że kolumna klucz_podstawowy repliki będzie zawierać identyfikator obiektu SolidLines Ticketing System',
...
"Zaktualizuj, a następnie usuń": zastosuj „Zasady aktualizacji”. Po wygaśnięciu czasu przechowywania wykonaj polecenie „Usuń”',
	...
	'Class:AuditCategory/Attribute:ok_error_tolerance' => 'Próg ostrzegawczy',
	'Class:AuditCategory/Attribute:ok_error_tolerance+' => 'Procent nieprawidłowych obiektów, poniżej którego wynikiem jest ostrzeżenie (pomarańczowy)',
	'Class:AuditCategory/Attribute:warning_error_tolerance' => 'Próg błędu',
...
Domena zazwyczaj odpowiada temu, kto jest odpowiedzialny za sprawdzanie i naprawianie błędów',
	...
	'Class:lnkAuditCategoryToAuditDomain/Attribute:category_name+' => 'Nazwa kategorii audytu',
	'Class:lnkAuditCategoryToAuditDomain/Attribute:domain_id' => 'Domena',
	...
	'Class:Query/Attribute:export_count' => 'Licznik eksportu',
	'Class:Query/Attribute:export_count+' => 'Licznik odzwierciedlający liczbę wykonanych zapytań',
	'Class:Query/Attribute:export_last_date' => 'Ostatni eksport',
	'Class:Query/Attribute:export_last_date+' => 'Data i godzina ostatniej realizacji eksportu',
	...
	'Class:User/Warning:NoOrganizationMeansFullAccess' => 'Dla tego użytkownika nie zdefiniowano „Dozwolonych organizacji”, co oznacza, że ​​ma on dostęp do wszystkich organizacji',
	...
	'Class:UserInternal+' => 'Użytkownik zdefiniowany w ramach SolidLines Ticketing System',
	...
	'Menu:WelcomeMenu+' => 'Witaj w SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => 'Witaj',
	'Menu:WelcomeMenuPage+' => 'Witaj w SolidLines Ticketing System',
	...
	'BooleanLabel:no' => 'nie',
	'UI:Login:Title' => 'SolidLines Ticketing System login',
	'UI:WelcomeMenu:Title' => 'Witaj w SolidLines Ticketing System',
	...
	'UI:Error:UploadedFileTooBig' => 'Przesłany plik jest za duży. (Dopuszczalny rozmiar %1$s). Aby zmienić ten limit, skontaktuj się z administratorem SolidLines Ticketing System. (Sprawdź konfigurację PHP pod kątem upload_max_filesize i post_max_size na serwerze).',
	...
	'UI:Menu:BulkDelete_Class' => 'Usuń obiekty %1$s...',
	'UI:Menu:BulkDelete_Link' => 'Usuń %1$s...',
	'UI:Menu:BulkDelete_Remote' => 'Usuń %1$s...',
	...
	'UI:Login:Welcome' => 'Witamy w SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System może wysłać Ci wiadomość e-mail, w której znajdziesz instrukcje dotyczące resetowania hasła.',
	...
	'UI:ResetPwd-EmailSubject' => 'Reset hasła SolidLines Ticketing System',
	'UI:ResetPwd-EmailBody' => '<body><p>Poprosiłeś o zresetowanie hasła SolidLines Ticketing System.</p><p>Proszę skorzystać z tego linku (jednorazowe użycie), <a href="%1$s">wpisz nowe hasło</a></p>.',
	...
	'UI:Login:About' => 'SolidLines Ticketing System Obsługiwane przez Combodo',
	...
	'UI:LogOff:ThankYou' => 'Dziękujemy za użycie SolidLines Ticketing System',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System jest tylko do odczytu',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System jest tylko do odczytu dla użytkowników końcowych',
	...
	'UI:Button:Login' => 'Wejdź do SolidLines Ticketing System',
	'UI:Login:Error:AccessRestricted' => 'SolidLines Ticketing System dostęp jest ograniczony. Prosimy o kontakt z administratorem SolidLines Ticketing System.',
	'UI:Login:Error:AccessAdmin' => 'Dostęp ograniczony do osób z uprawnieniami administratora. Prosimy o kontakt z administratorem SolidLines Ticketing System.',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - Import zbiorczy',
	...
	'UI:CSVImport:Column' => 'Kolumna %1$s',
	...
	'UI:CSVImport:ViewAllPossibleValues' => 'Wyświetl wszystkie możliwe wartości',
	'UI:CSVImport:ViewAllAmbiguousValues' => 'Wyświetl wszystkie niejednoznaczne wartości',
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Wyszukiwanie uniwersalne',
	...
	'UI:CSVReport-Value-NoMatch-PossibleValues' => 'Możliwe wartości \'%1$s\': %2$s',
	'UI:CSVReport-Value-NoMatch-NoObject' => 'Brak obiektów \'%1$s\'',
	'UI:CSVReport-Value-NoMatch-NoObject-ForCurrentUser' => 'Brak obiektów \'%1$s\' w Twoim bieżącym profilu',
	...
	'UI:CSVReport-Value-Issue-AllowedValues' => 'Dozwolone wartości \'%1$s\': %2$s',
	...
	'UI:CSVReport-Row-Issue-ExpectedDateFormat' => 'Oczekiwany format: %1$s',
	...
	'UI:CSVExport:LostChars+' => 'Pobrany plik zostanie zakodowany w formacie %1$s. SolidLines Ticketing System wykrył znaki, które nie są zgodne z tym formatem. Znaki te zostaną albo zastąpione substytutem (np. zaakcentowane znaki tracące akcent), albo zostaną odrzucone. Możesz skopiować / wkleić dane z przeglądarki internetowej. Alternatywnie możesz skontaktować się z administratorem w celu zmiany kodowania (patrz parametr \'csv_file_default_charset\').',
	'UI:Audit:Title' => 'SolidLines Ticketing System - Audyt CMDB',
	'UI:Audit:Interactive:All:Title' => 'Wyniki audytu',
	'UI:Audit:Interactive:All:SubTitle' => 'Pełny audyt: obejmuje wszystkie reguły, wszystkie kategorie i wszystkie domeny',
	'UI:Audit:Interactive:All:BreadCrumb' => 'Pełny audyt',
	'UI:Audit:Interactive:All:BreadCrumb+' => 'Wyniki audytu dla wszystkich reguł',
	'UI:Audit:Interactive:Categories:Title' => 'Wyniki audytu dla kategorii: %1$s',
	'UI:Audit:Interactive:Categories:SubTitle' => 'Wyniki inspekcji dla wszystkich reguł należących do jednej z tych kategorii %1$s',
	'UI:Audit:Interactive:Categories:BreadCrumb' => 'Kategorie',
	'UI:Audit:Interactive:Categories:BreadCrumb+' => 'Kategorie audytu: %1$s',
	'UI:Audit:Interactive:Domain:Title' => 'Wyniki audytu dla domeny: %1$s',
	'UI:Audit:Interactive:Domain:SubTitle' => 'Wyniki audytu dla wszystkich reguł należących do kategorii powiązanej z domeną: %1$s',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - Wykonywanie zapytań OQL',
	...
	'UI:Schema:Events' => 'Zdarzenia',
	'UI:Schema:Events:Defined' => 'Zdefiniowane zdarzenia',
	'UI:Schema:Events:NoEvent' => 'Nie zdefiniowano żadnego zdarzenia',
	'UI:Schema:Events:Listeners' => 'Detektory zdarzeń',
	'UI:Schema:Events:NoListener' => 'Brak detektora zdarzeń',
	'UI:Schema:Events:Event' => 'Zdarzenie',
	'UI:Schema:Events:Description' => 'Opis',
	'UI:Schema:Events:Listener' => 'Detektor',
	'UI:Schema:Events:Rank' => 'Ranga',
	'UI:Schema:Events:Module' => 'Moduł',
	...
	'UI:WelcomeToITop' => 'Witaj w SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$s szczegóły',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - Błąd',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Wyniki wyszukiwania',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s zmiana',
	'UI:ModificationTitle_Class_Object' => 'Zmiana %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - Klonuj %1$s - %2$s zmianę',
	'UI:CloneTitle_Class_Object' => 'Klonuje %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - Tworzenie %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Usuń zbiorczo',
	'UI:BulkDeleteTitle' => 'Wybierz obiekty, które chcesz usunąć:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System Utworzono obiekt.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Błąd krytyczny',
	'UI:SystemIntrusion' => 'Brak dostępu. Zażądałeś operacji, która nie jest dla Ciebie dozwolona.',
	'UI:FatalErrorMessage' => 'Błąd krytyczny, SolidLines Ticketing System nie może kontynuować.',
	'UI:Error_Details' => 'Błąd: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System zarządzanie użytkownikami - projekcje profili',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>W SolidLines Ticketing System powiadomienia są w pełni konfigurowalne. Opierają się na dwóch zestawach obiektów: <i> wyzwalaczach i działaniach </i>.</p>
<p><i><b>Wyzwalacze</b></i> określają, kiedy powiadomienie zostanie wykonane. W ramach programu istnieją różne wyzwalacze SolidLines Ticketing System, ale inne mogą zostać wprowadzone przez rozszerzenia:
<ol>
...
W przypadku powiązania z wyzwalaczem, każde działanie otrzymuje numer "porządkowy", określający, w jakiej kolejności mają być wykonywane.</p>',
	...
	'Portal:Title' => 'SolidLines Ticketing System portal użytkownika',
	'Portal:NoRequestMgmt' => 'Drogi %1$s, zostałeś przekierowany na tę stronę, ponieważ Twoje konto jest skonfigurowane z profilem \'Portal użytkownika\'.Niestety, SolidLines Ticketing System nie został zainstalowany z funkcją \'Zarządzanie zgłoszeniami\'.Skontaktuj się z administratorem.',
	...
	'UI:Modify_ObjectsOf_Class' => 'Zmiana obiektów klasy %1$s',
	...
	'UI:Menu:ModifyAll_Class' => 'Zmień obiekty %1$s...',
	'UI:Menu:ModifyAll_Link' => 'Zmień %1$s...',
	'UI:Menu:ModifyAll_Remote' => 'Zmień %1$s...',
	...
	'UI:AutoApplyConfirmationMessage' => 'Niektóre zmiany nie zostały jeszcze zastosowane. Czy chcesz aby SolidLines Ticketing System wziął je pod uwagę?',
	...
	'UI:Menu:FilterList' => 'Wyświetl listę z kryteriami wyszukiwania',
...
<tr><td>s</td><td>sekundy (2 cyfry, np. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'O SolidLines Ticketing System...',
	'UI:About:Title' => 'O SolidLines Ticketing System',
	...
	'portal:backoffice' => 'SolidLines Ticketing System Interfejs użytkownika biurowego',
	...
	'UI:Newsroom:ResetCache:Success:Message' => 'Pamięć podręczna Twojego newsroomu została pomyślnie zresetowana',
	'UI:Newsroom:DisplayMessagesFor_Provider' => 'Wyświetl wiadomości od %1$Modyfikowanie obiektów klasys',
	'UI:Newsroom:DisplayAtMost_X_Messages' => 'Wyświetlaj do %1$s wiadomiości w %2$s menu.',
	'UI:Newsroom:Priority:1:Tooltip' => 'Krytyczny',
	...
	'Menu:AuditCategories+' => 'Kategorie audytu',
	'Menu:AuditCategories:Title' => 'Konfiguracja audytu',
...
- Zespół R&amp;D',
	...
	'UI:NotificationsCenter:Panel:Toolbar:ViewAllNews:Title' => 'Zobacz wszystkie moje aktualności',
	'UI:NotificationsCenter:Panel:Table:Channels' => 'Kanały',
	'UI:NotificationsCenter:Unsubscribe:Success' => 'Pomyślnie wypisałeś się z wybranych powiadomień.',
	'UI:NotificationsCenter:Unsubscribe:Error' => 'Wystąpił błąd podczas anulowania subskrypcji wybranych powiadomień.',
	'UI:NotificationsCenter:Subscribe:Success' => 'Pomyślnie zasubskrybowałeś wybrane powiadomienia.',
	...
	'UI:Layout:ObjectDetails:New:Modal:Title' => 'Tworzenie obiektu',
	'UI:Layout:ObjectDetails:DatamodelSchemaLink:Tooltip' => 'Schemat modelu danych klas',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Witaj w SolidLines Ticketing System 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Gratulacje, trafiłeś do SolidLines Ticketing System Fullmoon!</div>
<br>
<div>Z radością ogłaszamy tę nową wersję. </div>
<div>Oprócz wprowadzenia nowych funkcji, takich jak Newsroom, SolidLines Ticketing System wersja 3.2 zawiera krytyczne poprawki bezpieczeństwa, zwiększoną dostępność i inne znaczące ulepszenia mające na celu zapewnienie stabilności i bezpieczeństwa.</div>
<br>
<div>Odkryj wszystkie ekscytujące nowe funkcje SolidLines Ticketing System i bądź na bieżąco z ważnymi powiadomieniami dzięki naszemu nowemu wyskakującemu okienku powitalnemu!</div>
<div>Mamy nadzieję, że spodoba ci się ta wersja tak samo, jak nam podobało się jej wyobrażanie i tworzenie.</div>
<br>
<div>Dostosuj swoją aplikację SolidLines Ticketing System w preferencjach dotyczących spersonalizowanych doświadczeń.</div>',
	'UI:WelcomePopup:Message:320_02_Newsroom:Title' => 'Przywitaj się z newsroomem',
	'UI:WelcomePopup:Message:320_02_Newsroom:Description' => '<div>Pożegnaj zaśmiecone skrzynki odbiorcze i przywitaj się ze spersonalizowanymi alertami <a href="%1$s" target="_blank">SolidLines Ticketing System\'s Newsroom</a>!</div>
...
<br>
<div>Wypróbuj już dziś i usprawnij swoje doświadczenie komunikacji w SolidLines Ticketing System!</div>',
...
<div>Uzyskaj dostęp do swojego centrum powiadomień poprzez newsroom lub poprzez swoje preferencje i unikaj przeciążenia informacjami we wszystkich kanałach komunikacji!</div>',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Title' => 'Dostępność SolidLines Ticketing System',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Description' => '<div>Aby zapewnić dostępnośćSolidLines Ticketing System, nasz zespół pracował nad nowymi motywami zaplecza. Zgodny z WCAG, interfejs użytkownika skupia się na ułatwieniu użytkownikom z wadami wzroku korzystania z rozwiązania:
<ul>
	...
	'UI:WelcomePopup:Message:320_04_PowerfulNotifications_AdminOnly:Description' => '<div>SolidLines Ticketing System Newsroom oferuje nowy sposób <b>automatyzacji</b> alertów na podstawie powtarzających się zdarzeń, dzięki czemu możesz łatwo skonfigurować odpowiednie dla siebie reguły. </div>
...
<div>Skonfiguruj już dziś i przekonaj się, o ile efektywniejszy może być Twój proces alertów!</div>',
	...
	'UI:Links:Create:Modal:Title' => 'Tworzy %4$s w %2$s',
	'UI:Links:Add:Button' => 'Dodaj',
	'UI:Links:Add:Button+' => 'Dodaje %4$s',
	'UI:Links:Add:Modal:Title' => 'Dodaje %4$s do %2$s',
	'UI:Links:ModifyLink:Button' => 'Zmień',
	'UI:Links:ModifyLink:Button+' => 'Zmień łącze',
	'UI:Links:ModifyLink:Modal:Title' => 'Zmodyfikuj łącze między %2$s i %5$s',
	'UI:Links:ModifyObject:Button' => 'Zmień',
	'UI:Links:ModifyObject:Button+' => 'Zmodyfikuj ten obiekt',
	'UI:Links:ModifyObject:Modal:Title' => '%5$s',
	'UI:Links:Remove:Button' => 'Usuń',
	'UI:Links:Remove:Button+' => 'Usuń %4$s',
	'UI:Links:Remove:Modal:Title' => 'Usuń %4$s z jego %1$s',
	'UI:Links:Remove:Modal:Message' => 'Czy na pewno chcesz usunąć %5$s z %2$s?',
	'UI:Links:Delete:Button' => 'Usuń',
	'UI:Links:Delete:Button+' => 'Usuń %4$s',
	'UI:Links:Delete:Modal:Title' => 'Usuń %4$s',
	'UI:Links:Delete:Modal:Message' => 'Czy na pewno chcesz usunąć %5$s?',
	'UI:Links:Bulk:LinkWillBeCreatedForAllObjects' => 'Dodaj do wszystkich obiektów',
	'UI:Links:Bulk:LinkWillBeDeletedFromAllObjects' => 'Usuń ze wszystkich obiektów',
	'UI:Links:Bulk:LinkWillBeCreatedFor1Object' => 'Dodaj do jednego obiektu',
	'UI:Links:Bulk:LinkWillBeDeletedFrom1Object' => 'Usuń z jednego obiektu',
	'UI:Links:Bulk:LinkWillBeCreatedForXObjects' => 'Dodaj {count} obiektów',
	'UI:Links:Bulk:LinkWillBeDeletedFromXObjects' => 'Usuń z {count} obiektów',
	'UI:Links:Bulk:LinkExistForAllObjects' => 'Wszystkie obiekty są już połączone',
	...
	'UI:Newsroom:iTopNotification:Label' => 'SolidLines Ticketing System',
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Twoje wiadomości SolidLines Ticketing System',
	...
	'Class:UserExternal+' => 'Użytkownik uwierzytelniony poza SolidLines Ticketing System',
	...
	'Class:UserLocal' => 'Użytkownik SolidLines Ticketing System',
	'Class:UserLocal+' => 'Użytkownik uwierzytelniony przez SolidLines Ticketing System',
	...
	'theme:fullmoon-tritanopia' => 'Pełnia Księżyca (Tritanopia)',
...
lub zapytaj administratora SolidLines Ticketing System, czy dysk serwera SolidLines Ticketing System jest pełny.',
	...
	'config-not-allowed-in-demo' => 'Sorry, SolidLines Ticketing System jest w <b>trybie demonstracyjnym</b>: nie można edytować pliku konfiguracyjnego.',
	'config-interactive-not-allowed' => 'SolidLines Ticketing System interaktywna edycja konfiguracji została wyłączona. Zobacz <code>\'config_editor\' => \'disabled\'</code> w pliku konfiguracyjnym.',
	...
	'iTopUpdate:UI:Setup' => 'Konfiguracja SolidLines Ticketing System',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'Przestrzeń dyskowa  SolidLines Ticketing System',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Uruchom konfigurację SolidLines Ticketing System',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Zostanie uruchomiona SolidLines Ticketing System konfiguracja, jesteś pewien?',
	...
	'Menu:iTopHub:Register+' => 'Przejdź do iTop Hub, aby zaktualizować swoją instancję SolidLines Ticketing System',
	'Menu:iTopHub:Register:Description' => '<p>Uzyskaj dostęp do swojej platformy społecznościowej iTop Hub!</br>Znajdź wszystkie potrzebne treści i informacje, zarządzaj swoimi instancjami za pomocą spersonalizowanych narzędzi i zainstaluj więcej rozszerzeń.</br><br/>Łącząc się z Centrum z tej strony, będziesz przesyłać informacje o tej instancji SolidLines Ticketing System do Centrum.</p>',
	'Menu:iTopHub:MyExtensions' => 'Wdrożone rozszerzenia',
	'Menu:iTopHub:MyExtensions+' => 'Zobacz listę rozszerzeń wdrożonych w tej instancji SolidLines Ticketing System',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Zajrzyj do sklepu iTop Hub, jedynego miejsca, w którym można znaleźć wspaniałe rozszerzenia SolidLines Ticketing System!</br>Znajdź te, które pomogą Ci dostosować i dostosować SolidLines Ticketing System do Twoich procesów.</br><br/>Łącząc się z Centrum z tej strony, będziesz przesyłać informacje o tej instancji SolidLines Ticketing System do Centrum.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Wykryto błąd podczas wdrażania!<br/>Konfiguracja SolidLines Ticketing System NIE została zmodyfikowana.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Następujące rozszerzenia zostały wdrożone przez ręczne skopiowanie ich do katalogu %1$s programu SolidLines Ticketing System:',
	...
	'iTopHub:NoExtensionInThisCategory' => 'W tej kategorii nie ma rozszerzenia.<br/><br/>Przeglądaj iTop Hub, aby znaleźć rozszerzenia, które pomogą Ci dostosować i dostosować SolidLines Ticketing System do Twoich procesów.',
	...
	'iTopHub:LandingWelcome' => 'Gratulacje! Następujące rozszerzenia zostały pobrane z iTop Hub i wdrożone w SolidLines Ticketing System.',
	'iTopHub:GoBackToITopBtn' => 'Wróć do SolidLines Ticketing System',
	...
	'iTopHub:DBBackupSentence' => 'Przed aktualizacją wykonaj kopię zapasową bazy danych i konfiguracji SolidLines Ticketing System',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Kopia zapasowa instancji SolidLines Ticketing System...',
...
Usuń pole, aby ponownie obliczyć wartość domyślną',
	...
	'Class:PersonalToken+' => 'Personal token for accessing SolidLines Ticketing System webservices, import, export, rest and data synchro',
	...
	'Class:UserToken+' => 'User for remote applications accessing SolidLines Ticketing System webservices',
...
IMPORTANT: If set, the \'message\' will be ignored.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Include a button below the message to delete the object in SolidLines Ticketing System',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Include a button below the message to edit the object in SolidLines Ticketing System',
...
IMPORTANT: If set, the \'message\' and all \'bot information\' will be ignored.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Include a button below the message to delete the object in SolidLines Ticketing System',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Include a button below the message to edit the object in SolidLines Ticketing System',
...
- $oResponse can be null in some cases (eg. request failed to send)',
	...
	'Class:ActioniTopWebhook' => 'Action by SolidLines Ticketing System REST API',
