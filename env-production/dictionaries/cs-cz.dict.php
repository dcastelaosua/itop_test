...
- V opačném případě se použije kompaktní logo aplikace',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Zdroj dat pro synchronizaci může naplnit pouze jednu třídu SolidLines Ticketing System',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hypertextový odkaz na ikonu reprezentující aplikaci, se kterou je SolidLines Ticketing System synchronizovnán',
	'Class:SynchroDataSource/Attribute:url_application' => 'Aplikace',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hypertextový odkaz na SolidLines Ticketing System objekt v externí aplikaci, se kterou je SolidLines Ticketing System synchronizován (pokud je to relevantní). Možné zástupné symboly: $this->attribute$ a $replica->primary_key$',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => 'Způsob párování',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Použijte atribut": SolidLines Ticketing System objekt odpovídá hodnotám replik pro jednotivé atributy synchronizace označené pro odsouhlasení.
"Použít primary_key": sloupec primary_key repliky by měl obsahovat identifikátor objektu SolidLines Ticketing System',
...
Domény nejčastěji odpovídají skupinám řešitelů, které následně opravují chyby nalezené auditem',
	...
	'Class:UserInternal+' => 'Uživatel definovaný v SolidLines Ticketing System',
	...
	'Menu:WelcomeMenu+' => 'Vítejte v SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => 'Vítejte',
	'Menu:WelcomeMenuPage+' => 'Vítejte v SolidLines Ticketing System',
	...
	'UI:WelcomeMenu:Title' => 'Vítejte v SolidLines Ticketing System',
	...
	'UI:Login:Welcome' => 'Vítejte v SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System vám může zaslat instrukce pro obnovení vašeho hesla.',
	...
	'UI:ResetPwd-EmailSubject' => 'Obnovení hesla pro SolidLines Ticketing System',
	'UI:ResetPwd-EmailBody' => '<body><p>Vyžádali jste obovení hesla pro SolidLines Ticketing System.</p><p>Pokračujte kliknutím na následující <a href="%1$s">jednorázový odkaz</a> a zadejte nové heslo.</p>',
	...
	'UI:LogOff:ThankYou' => 'Děkujeme za užívání SolidLines Ticketing System',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System je pouze ke čtení',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System je pouze ke čtení pro koncové uživatele',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - hromadný import',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Univerzální hledání',
	...
	'UI:CSVExport:LostChars+' => 'CSV soubor bude kódován v %1$s. SolidLines Ticketing System zjistil, že některé charaktery nejsou s tímto kódováním kompatibilní. Tyto znaky budou nahrazeny zástupným znakem, nebo budou vynechány. Kontaktujte administrátora pro změnu kódování (parametr \'csv_file_default_charset\').',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - Vyhodnocení OQL dotazu',
	...
	'UI:Schema:Title' => 'SolidLines Ticketing System schéma objektů',
	...
	'UI:WelcomeToITop' => 'Vítejte v SolidLines Ticketing System',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Výsledky hledání',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - úprava - %1$s - %2$s',
	'UI:ModificationTitle_Class_Object' => 'Úprava %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - Klonování %1$s - %2$s',
	'UI:CloneTitle_Class_Object' => 'Klonování %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - Vytváření nového objektu (%1$s) ',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Hromadné odstranění',
	'UI:BulkDeleteTitle' => 'Vyberte objekty, které chcete odstranit:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System Objekt vytvořen.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Závažná chyba',
	'UI:SystemIntrusion' => 'Přístup odepřen. Vyžadujete operaci, která vám není povolena.',
	'UI:FatalErrorMessage' => 'Závažná chyba, SolidLines Ticketing System nemůže pokračovat.',
	'UI:Error_Details' => 'Chyba: %1$s',
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System správa uživatelů - projekce profilů',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Upozornění v SolidLines Ticketing System jsou plně nastavitelné. Jsou založena na dvou druzích objektů: <i>trigery (spouštěče) a akce</i>.</p>
<p><i><b>Trigery</b></i> definují, kdy bude oznámení provedeno. Součástí jádra SolidLines Ticketing System jsou různé trigery, ale další mohou být přidány rožšířením:
<ol>
...
<p>Aby mohly být akce spuštěny, musí být přiřazeny ke trigerům. Každá akce pak dostane své "pořadové" číslo, které určí v jakém pořadí se akce spustí.</p>',
	...
	'Portal:Title' => 'SolidLines Ticketing System uživatelský portál',
	'Portal:NoRequestMgmt' => 'Byli jste přesměrováni na tuto stránku, protože k vašemu účtu je přidělen profil \'Portal user\'. SolidLines Ticketing System však nebyl nainstalován s funkcí \'Request Management\'.Kontaktujte prosím vašeho administrátora.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Některé změny nebyly dosud použity. Chcete aby je SolidLines Ticketing System zohlednil?',
	...
	'portal:backoffice' => 'SolidLines Ticketing System Back-Office',
...
- The R&amp;D Team',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Vítejte v SolidLines Ticketing System 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Gratulujeme, přistáli jste do SolidLines Ticketing System Fullmoon!</div>
<br>
<div>Jsme rádi, že vám můžeme představit tuto novou verzi. </div>
<div>Kromě nových funkcionalit, jako je např. Newsroom, SolidLines Ticketing System obsahuje verze 3.2 bezpečnostní opravy, lepší přístupnost a další významná vylepšení zaměřená na zajištění stability a bezpečnosti.</div>
<br>
<div>Objevte všechny SolidLines Ticketing System vzrušující nové funkce a zůstaňte informováni o důležitých oznámeních a aktualizacích prostřednictvím nového vyskakovacího okna na uvítanou!</div>
<div>Doufáme, že se vám tato verze bude líbit stejně, jako se nám líbila její tvorba.</div>
<br>
<div>Přizpůsobte si svoje předvolby SolidLines Ticketing System a získejte tak individuální zážitek.</div>',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Vaše SolidLines Ticketing System novinky',
	...
	'Class:UserExternal+' => 'Uživatel definovaný mimo SolidLines Ticketing System',
	...
	'Class:UserLocal' => 'interní uživatel SolidLines Ticketing System',
	'Class:UserLocal+' => 'Uživatel ověřen interně v SolidLines Ticketing System',
...
nebe se zeptejteSolidLines Ticketing System správce SolidLines Ticketing System zda není zaplněný disk.',
	...
	'config-edit-intro' => 'Při úpravách konfiguračního souboru buďte velice opatrní. Nesprávné nastavení může vést k nedostupnosti SolidLines Ticketing System',
	'config-apply' => 'Použít',
	...
	'config-not-allowed-in-demo' => 'Omlouvám se, SolidLines Ticketing System je v <b>předváděcí režimu</b>: Konfigurace nemůže být editována',
	...
	'Organization:Overview:Users' => 'SolidLines Ticketing System Uživatelé v rámci této organizace',
...
If using OQL, objects proposed are limited to User rights. User Portal scopes are not applied.',
	...
	'Menu:iTopHub:MyExtensions+' => 'Seznam rozšíření nasazených v rámci instance SolidLines Ticketing System',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Tato rozšíření byla nasazena manuálně a to kopiií souborů do adresáře %1$s instance SolidLines Ticketing System:',
	...
	'iTopHub:LandingWelcome' => 'Gratuluji! Následující rozšíření jsou úspěšně stažena z iTop Hubu a nasazena v rámci instance SolidLines Ticketing System.',
