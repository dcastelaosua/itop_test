...
Dict::SetEntries('FR FR', array(
	...
	'Core:AttributeTemplateString+' => 'Chaîne de caractères d\'une ligne, contenant des espaces réservés pour des données SolidLines Ticketing System',
	'Core:AttributeTemplateText' => 'Modèle de texte',
	'Core:AttributeTemplateText+' => 'Texte contenant des espaces réservés pour des données SolidLines Ticketing System',
	'Core:AttributeTemplateHTML' => 'Modèle HTML',
	'Core:AttributeTemplateHTML+' => 'HTML contenant des espaces réservés pour des données SolidLines Ticketing System',
...
- Sinon, le logo compact de l\'application sera utilisé',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Une Source de données ne peut alimenter qu\'une seule classe SolidLines Ticketing System',
...
Ce lien est affiché dans le tootip du cadenas, visible sur les objets SolidLines Ticketing System synchronisés',
...
L\'hyperlien est affiché dans le tootip du cadenas, visible sur les objets SolidLines Ticketing System synchronisés',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => 'Politique de recherche',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => 'Pour retrouver le(s) objet(s) SolidLines Ticketing System correspondant à l\'objet source :
...
Soit on recherche directement l\'objet sur son id qui doit être égal au "primary_key" de la source',
	...
	'Class:SynchroDataSource/Attribute:action_on_zero+' => 'Que fait-on si aucun objet SolidLines Ticketing System ne correspond à l\'objet source',
	'Class:SynchroDataSource/Attribute:action_on_one' => 'Action si un',
	'Class:SynchroDataSource/Attribute:action_on_one+' => 'Que fait-on lorsqu\'un seul objet SolidLines Ticketing System correspond à l\'objet source',
	'Class:SynchroDataSource/Attribute:action_on_multiple' => 'Action si plusieurs',
	'Class:SynchroDataSource/Attribute:action_on_multiple+' => 'Que fait-on lorsque plus d\'un objet SolidLines Ticketing System correspond à l\'objet source',
...
Plusieurs champs peuvent ainsi être modifiés lors d\'une "mise à jour" en application de la politique d\'effacement',
	...
	'Class:SynchroDataSource/Attribute:delete_policy+' => 'Que fait-on avec l\'objet SolidLines Ticketing System synchronisé lorsque objet source n\'est plus présent ?
"Ignorer" : on ne fait rien, l\'objet demeure dans SolidLines Ticketing System inchangé,
"Effacer" : l\'objet SolidLines Ticketing System est supprimé ainsi que son replica,
"Mettre à jour" : les régles décrites dans le champ "mise à jour" sont appliquées à l\'objet SolidLines Ticketing System qui est donc modifié,
"Mettre à jour puis effacer" : on effectue immédiatement une mise à jour, et lorsque la durée de rétention est atteinte, on supprime l\'objet SolidLines Ticketing System',
...
Lorsqu\'on execute l\'audit sur un domaine, toutes les catégories d\'audit incluses sont vérifiées en même temps et seulement celles là',
	...
	'Class:User/Attribute:login+' => 'Indentifiant de ce compte, doit être unique au sein d\'SolidLines Ticketing System',
	'Class:User/Attribute:language' => 'Langue',
	'Class:User/Attribute:language+' => 'Langue de défaut d\'SolidLines Ticketing System pour cet utilisateur, à choisir parmi les langues dans lequelles SolidLines Ticketing System a été traduit.',
	...
	'Class:UserInternal+' => 'Utilisateur défini dans SolidLines Ticketing System',
	...
	'Menu:WelcomeMenu+' => 'Bienvenue dans SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => 'Bienvenue',
	'Menu:WelcomeMenuPage+' => 'Bienvenue dans SolidLines Ticketing System',
	...
	'UI:WelcomeMenu:Title' => 'Bienvenue dans SolidLines Ticketing System',
	...
	'UI:WelcomeMenu:Text' => '<div>Félicitations, vous avez atterri sur SolidLines Ticketing System Fullmoon !</div>

<div>Cette version présente un tout nouveau design moderne et accessible pour la console de support.</div>

<div>Nous avons conservé les fonctions de base d\'SolidLines Ticketing System que vous aviez apprécié et les avons modernisées pour vous les faire adorer.
Nous espérons que vous aimerez cette version autant que nous avons eu du plaisir à l\'imaginer et à la créer.</div>

<div>Configurez vos préférences SolidLines Ticketing System pour une expérience personnalisée.</div>',
	...
	'UI:Error:UploadedFileTooBig' => 'Le fichier téléchargé est trop gros. (La taille maximale autorisée est %1$s). Pour modifier cette limite contactez votre administrateur SolidLines Ticketing System. (Réglages upload_max_filesize et post_max_size dans la configuration PHP sur le serveur)',
	...
	'UI:Login:Welcome' => 'Bienvenue dans SolidLines Ticketing System!',
	...
	'UI:ResetPwd-Error-NotPossible' => 'les comptes "externes" ne permettent pas la saisie d\'un mot de passe dans SolidLines Ticketing System.',
	...
	'UI:ResetPwd-EmailSubject' => 'Changer votre mot de passe SolidLines Ticketing System',
	'UI:ResetPwd-EmailBody' => '<body><p>Vous avez demandé à changer votre mot de passe SolidLines Ticketing System sans connaître le mot de passe précédent.</p><p>Veuillez suivre le lien suivant (usage unique) afin de pouvoir <a href="%1$s">saisir un nouveau mot de passe</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Merci d\'avoir utilisé SolidLines Ticketing System',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System est en lecture seule',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System est en lecture seule pour les utilisateurs finaux',
	...
	'UI:Button:Login' => 'Entrer dans SolidLines Ticketing System',
	'UI:Login:Error:AccessRestricted' => 'L\'accès à cette page SolidLines Ticketing System est soumis à autorisation. Merci de contacter votre administrateur SolidLines Ticketing System.',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - Import massif',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Recherche universelle',
	...
	'UI:Audit:Title' => 'SolidLines Ticketing System - Audit de la CMDB',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - Evaluation de requêtes OQL',
	...
	'UI:Schema:Title' => 'Modèle de données SolidLines Ticketing System',
	...
	'UI:WelcomeToITop' => 'Bienvenue dans SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %2$s - Détails de %1$s',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - Erreur',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Résultats de la recherche',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %2$s - Modification de %1$s',
	'UI:ModificationTitle_Class_Object' => '%1$s - Modification de <span class="hilite">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - %2$s - Duplication de %1$s',
	'UI:CloneTitle_Class_Object' => ' %1$s - Duplication de <span class="hilite">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - Création d\'un objet de type %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Suppression massive',
	'UI:BulkDeleteTitle' => 'Sélectionnez les objets à supprimer:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System objet créé.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Erreur Fatale',
	...
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System gestion des utilisateurs - projections des profils',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Dans SolidLines Ticketing System les notifications sont totalement configurables. Elles sont basées sur deux types d\'objets: <i>déclencheurs et actions</i>.</p>
...
Lors de l\'association à un déclencheur, on attribue à chaque action un numéro d\'ordre, qui définit la séquence des actions à exécuter.</p>',
	...
	'Portal:Title' => 'Portail utilisateur SolidLines Ticketing System',
	'Portal:NoRequestMgmt' => 'Chèr(e) %1$s, vous avez été redirigé(e) vers cette page car votre compte utilisateur est configuré avec le profil \'Utilisateur du Portail\'.Malheureusement, iTop n\'a pas été installé avec le module de \'Gestion des Demandes\'.Merci de contacter votre administrateur SolidLines Ticketing System.',
...
<tr><td>s</td><td>secondes (sur 2 chiffres: 00..59)</td></tr>
	...
	'UI:AboutBox' => 'A propos d\'SolidLines Ticketing System...',
	'UI:About:Title' => 'A propos d\'SolidLines Ticketing System',
	...
	'portal:backoffice' => 'Console SolidLines Ticketing System',
	...
	'Menu:UserManagementMenu+' => 'Qui peut se connecter à SolidLines Ticketing System et y faire quoi ?',
...
- L\'équipe R&amp;D',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Bienvenue sur SolidLines Ticketing System 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Félicitations, vous avez atterri sur SolidLines Ticketing System Fullmoon !</div>
<br>
<div>Nous sommes ravis de vous présenter cette nouvelle version.</div>
<br>
<div>En plus d\'introduire de nouvelles fonctionnalités telles que la Newsroom, SolidLines Ticketing System 3.2 inclut des correctifs de sécurité critiques, une meilleure accessibilité et d\'autres améliorations significatives visant à vous apporter stabilité et sécurité.</div>
<br>
...
<div>Paramétrez vos préférences iTop pour une expérience personnalisée.</div>',
	...
	'UI:WelcomePopup:Message:320_02_Newsroom:Description' => '<div>Dites adieu aux boîtes de réception encombrées et bonjour aux alertes personnalisées grâce à la <a href="%1$s" target="_blank">Newsroom d\'SolidLines Ticketing System</a> !</div>
<br>
...
<br>
<div>Essayez-le dès aujourd\'hui et optimisez la communication de votre SolidLines Ticketing System !</div>',
...
<div>Accédez à votre <a href="%1$s" target="_blank">centre de notifications</a> via la newsroom ou vos préférences et évitez la surcharge d\'information sur vos canaux de communication !</div>',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Title' => 'Accessibilité de l\'interface utilisateur d\'SolidLines Ticketing System',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Description' => '<div>Afin d\'assurer l\'accessibilité d\'SolidLines Ticketing System, notre équipe a travaillé sur de <a href="%1$s" target="_blank">nouveaux thèmes pour la console</a>. Conformes aux normes WCAG, ces interfaces utilisateur visent à faciliter l\'utilisation de la solution par les utilisateurs souffrant de déficiences visuelles :
<ul>
...
<div>Configurez-le dès aujourd\'hui et voyez à quel point votre processus d\'alerte peut être plus efficace !</div>',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Vos news SolidLines Ticketing System',
	...
	'Class:UserExternal' => 'Utilisateur externe à SolidLines Ticketing System',
	'Class:UserExternal+' => 'Utilisateur authentifié à l\'extérieur de SolidLines Ticketing System',
	...
	'Class:UserLocal' => 'Utilisateur SolidLines Ticketing System',
	'Class:UserLocal+' => 'Utilisateur authentifié par SolidLines Ticketing System',
...
Soit demandez à votre administrateur système s\'il reste de la place disque disponible sur le serveur',
	...
	'config-edit-intro' => 'Attention: une configuration incorrecte peut rendre SolidLines Ticketing System inopérant pour tous les utilisateurs!',
	...
	'config-not-allowed-in-demo' => 'Désolé, SolidLines Ticketing System est en <b>mode démonstration</b> : la configuration ne peut pas être modifiée.',
	...
	'Organization:Overview:Users' => 'Utilisateurs SolidLines Ticketing System dans cette organisation',
	'Class:Location' => 'Lieu',
...
En cas d\'OQL, les objets proposés sont limités aux droits de l\'utilisateur. Les scopes du Portail Utilisateur ne sont pas applicables.',
	...
	'Menu:iTopHub:Register+' => 'Connectez-vous à iTop Hub pour enregistrer cette instance d\'SolidLines Ticketing System',
	'Menu:iTopHub:Register:Description' => '<p>Connectez-vous à la communauté iTop Hub!<br>Trouvez tout le contenu dont vous avez besoin, gérer vos instances d\'iTop depuis un tableau de bord centralisé et déployez de nouvelles extensions.<br><br>En vous connectant au Hub depuis cette page, vous transmettez au Hub des informations relatives à cette instance d\'SolidLines Ticketing System.</p>',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Découvrez le magasin d\'extensions iTop Hub !<br>Trouvez en quelques clics celles qui vous permettront de construire un iTop sur mesure qui se conforme à vos processus.<br><br>En vous connectant au Hub depuis cette page, vous transmettez au Hub des informations relatives à cette instance d\'SolidLines Ticketing System.</p>',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Les extensions ci-dessous ont été déployées en les copiant manuellement dans le répertoire %1$s d\'SolidLines Ticketing System:',
	...
	'iTopHub:LandingWelcome' => 'Félicitations! Les extensions ci-dessous ont été téléchargées depuis iTop Hub et installées sur cette instance d\'SolidLines Ticketing System.',
	'iTopHub:GoBackToITopBtn' => 'Retourner dans SolidLines Ticketing System',
	...
	'iTopHub:DBBackupLabel' => 'Sauvegarde de l\'instance SolidLines Ticketing System',
	'iTopHub:DBBackupSentence' => 'Faire une sauvegarde de la base de données et des paramétrages d\'SolidLines Ticketing System',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Sauvegarde de l\'instance SolidLines Ticketing System...',
...
Pour recalculer la valeur par défaut, il faut effacer le champ',
	...
	'Class:UserRequest/Attribute:origin/Value:mail+' => 'Demande créée suite à la reception d\'un email',
...
IMPORTANT : Si ce champ est renseigné, le champ \'message\' sera ignoré.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Ajoute un bouton sous le message pour supprimer l\'objet correspondant dans SolidLines Ticketing System',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Ajoute un bouton sous le message pour modifier l\'objet correspondant dans SolidLines Ticketing System',
...
IMPORTANT : Si ce champ est renseigné, les champs \'message\' et toutes les \'informations du bot\' seront ignorés.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Ajoute un bouton sous le message pour supprimer l\'objet correspondant dans SolidLines Ticketing System',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Ajoute un bouton sous le message pour modifier l\'objet correspondant dans SolidLines Ticketing System',
...
- $oResponse peut être null dans certains cas (ex : échec de l\'envoi de la requête)',
	...
	'Class:ActioniTopWebhook' => 'Action par API REST SolidLines Ticketing System',
