...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hyprinlink, SolidLines Ticketing System\'un senkronize edildiği uygulamayı temsil eden (küçük) bir görüntü',
	'Class:SynchroDataSource/Attribute:url_application' => 'Uygulama\'nın köprüsü',
	'Class:SynchroDataSource/Attribute:url_application+' => 'SolidLines Ticketing System\'un senkronize edildiği harici uygulamadaki SolidLines Ticketing System nesnesine köprü (varsa). Muhtemel yer tutucular: $this->attribute$ ve $replica->primary_key$',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:UserInternal+' => 'SolidLines Ticketing System\'ta tanımlanan kullanıcı',
	...
	'Menu:WelcomeMenu+' => 'SolidLines Ticketing System\'a Hoşgeldiniz',
	'Menu:WelcomeMenuPage' => 'Hoşgeldiniz',
	'Menu:WelcomeMenuPage+' => 'SolidLines Ticketing System\'a Hoşgeldiniz',
	...
	'UI:WelcomeMenu:Title' => 'SolidLines Ticketing System\'a Hoşgeldiniz',
	...
	'UI:Login:Welcome' => 'SolidLines Ticketing System\'a Hoşgeldiniz!',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System, hesabınızı sıfırlamak için izleyeceğiniz talimatları bulacağınız bir e-posta gönderebilir.',
	...
	'UI:ResetPwd-EmailSubject' => 'SolidLines Ticketing Systemşifrenizi sıfırlayın',
	'UI:ResetPwd-EmailBody' => '<body><p>SolidLines Ticketing System şifrenizin sıfırlanması talebinde bulundunuz.</p><p> Yeni şifre oluşturmak için lütfen aşağıdaki tek kullanımlık bağlantıyı <a href=\\"%1$s\\">takip ediniz.</a></p>',
	...
	'UI:LogOffMenu' => 'Çıkış',
	'UI:LogOff:ThankYou' => 'SolidLines Ticketing System Kullanıdığınız için teşekkürler',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System salt okunurdur',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System sadece son kullanıcılar için okunurdur',
	'UI:ApplicationEnvironment' => 'Uygulama Ortamı: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => 'Yeni şifre eşlenmedi !',
	'UI:Button:Login' => 'SolidLines Ticketing System\'a Giriş',
	'UI:Login:Error:AccessRestricted' => 'SolidLines Ticketing System erişim sınırlandırıldı. Sistem yöneticisi ile irtibata geçiniz',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - Toplu giriş',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Genel arama',
	...
	'UI:CSVExport:LostChars+' => 'İndirilen dosya %1$s\'ye kodlanır. SolidLines Ticketing System, bu formatla uyumlu olmayan bazı karakterleri tespit etti. Bu karakterler ya bir ikame ile değiştirilecektir (örneğin, vurgulanmış karakterleri aksanı kaybedilen) veya atılacaklardır. Verileri web tarayıcınızdan kopyalayabilir / yapıştırabilirsiniz. Alternatif olarak, kodlamayı değiştirmek için yöneticinize başvurabilirsiniz (bkz. Parametre \'csv_file_default_charset \').',
	'UI:Audit:Title' => 'SolidLines Ticketing System - CMDB Denetleme',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - OQL Sorgu değerlendirme',
	...
	'UI:WelcomeToITop' => 'SolidLines Ticketing System\'a Hoşgeldiniz',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$s detayları',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - Hata',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Arama Sonuçları',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s modifikasyon',
	'UI:ModificationTitle_Class_Object' => '%1$s: <span class=\\"hilite\\">%2$s</span> modifikasyonu',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s modifikasyonunu klonlayınız',
	'UI:CloneTitle_Class_Object' => '%1$s klonu: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - Yeni %1$s yaratımı',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Toplu silme işlemi',
	'UI:BulkDeleteTitle' => 'Silmek istediğiniz nesneleri seçiniz:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System Nesne yaratıldı.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Kritik Hata',
	...
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System Kullanıcı Yönetimi - profil koruması',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>In SolidLines Ticketing System uyarı mekanizması ihtiyaca göre uyarlanabilir. Uyarılar iki tip nesne üzerine kurulmuştur: <i>tetikleme (triggers) ve işlemler (actions)</i>.</p>
...
Tetikleme gerçekleştiriğinde işlemler tanımlanan sıra numarası ile gerçekleştirilir.</p>',
	...
	'Portal:Title' => 'SolidLines Ticketing System Kullanıcı Portalı',
	'Portal:NoRequestMgmt' => 'Sevgili %1$s, hesabınız profil \'Portal kullanıcısı \' ile yapılandırıldığından bu sayfaya yönlendirildiniz. Ne yazık ki, SolidLines Ticketing System, özellik \'istek yönetimi\' ile kurulmamıştır. Lütfen yöneticinize başvurun',
	...
	'UI:AutoApplyConfirmationMessage' => 'Bazı değişiklikler henüz uygulanmadı. SolidLines Ticketing System\'un değişiklikleri uygulamasını istiyor musunuz?',
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'AboutSolidLines Ticketing System...',
	...
	'portal:backoffice' => 'SolidLines Ticketing SystemArka Ofis Kullanıcı Arayüzü',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'Class:UserExternal+' => 'SolidLines Ticketing System dışında yetki kontrolü yapılan kullanıcı',
	...
	'Class:UserLocal' => 'SolidLines Ticketing System kullanıcısı',
	'Class:UserLocal+' => 'Yetki kontorlünü SolidLines Ticketing System tarafından yapılan kullanıcı',
