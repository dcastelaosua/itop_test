...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:UserInternal+' => 'Учетная запись создана внутри SolidLines Ticketing System',
	...
	'Menu:WelcomeMenu+' => 'Добро пожаловать в SolidLines Ticketing System',
	'Menu:WelcomeMenuPage' => 'Добро пожаловать',
	'Menu:WelcomeMenuPage+' => 'Добро пожаловать в SolidLines Ticketing System',
	...
	'BooleanLabel:yes' => 'да',
	'BooleanLabel:no' => 'нет',
	'UI:Login:Title' => 'Вход в SolidLines Ticketing System',
	'UI:WelcomeMenu:Title' => 'Добро пожаловать в SolidLines Ticketing System',
	...
	'UI:Login:Welcome' => 'Добро пожаловать в SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'Введите свой логин для входа в систему и нажмите "Отправить". SolidLines Ticketing System отправит email с инструкциями по восстановлению пароля на ваш электронный адрес.',
	...
	'UI:ResetPwd-EmailBody' => '<body><p>Вы запросили восстановление пароля SolidLines Ticketing System.</p><p>Пожалуйста, воспользуйтесь <a href="%1$s">этой ссылкой</a> для задания нового пароля.</p></body>',
	...
	'UI:LogOffMenu' => 'Выход',
	'UI:LogOff:ThankYou' => 'Спасибо за использование SolidLines Ticketing System',
	...
	'UI:Login:Error:AccessRestricted' => 'Доступ к SolidLines Ticketing System ограничен. Пожалуйста, свяжитесь с администратором SolidLines Ticketing System.',
	'UI:Login:Error:AccessAdmin' => 'Доступ ограничен для лиц с административными привилегиями. Пожалуйста, свяжитесь с администратором SolidLines Ticketing System.',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - Пакетный импорт',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Универсальный поиск',
	...
	'UI:Audit:Title' => 'SolidLines Ticketing System - Аудит CMDB',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - Оценка запросов OQL',
	...
	'UI:WelcomeToITop' => 'Добро пожаловать в SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$s подробности',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - Ошибка',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Результаты поиска',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - Изменение объекта %2$s - %1$s',
	'UI:ModificationTitle_Class_Object' => 'Изменение объекта %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - Клон %1$s - %2$s модификация',
	'UI:CloneTitle_Class_Object' => 'Клон %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - Создание объекта %1$s',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Пакетное удаление',
	'UI:BulkDeleteTitle' => 'Выбор объектов для удаления:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System Объект создан.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Критическая ошибка',
	'UI:SystemIntrusion' => 'Доступ запрещён. Вы пытаетесь выполнить неразрешённую операцию.',
	'UI:FatalErrorMessage' => 'Критическая ошибка, SolidLines Ticketing System не может продолжать работу.',
	'UI:Error_Details' => 'Ошибка: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System управление пользователями - проектирование профилей',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>В SolidLines Ticketing System полностью настраиваемые уведомления, которые основаны на двух наборах объектов: <i>триггерах и действиях</i>.</p>
<p><i><b>Триггеры</b></i> определяют, когда необходимо выполнить действия. Базовые триггеры доступны как часть ядра SolidLines Ticketing System, другие триггеры добавляются дополнительными расширениями:
<ol>
...
<p>Для выполнения действия связываются с триггерами. При связывании с триггером каждому действию присваивается порядковый номер, который указывает на очерёдность выполнения действий при срабатывании триггера.</p>',
	...
	'Portal:Title' => 'Пользовательский портал SolidLines Ticketing System',
	'Portal:NoRequestMgmt' => 'Уважаемый %1$s, вы были перенаправлены на портал, потому что ваш аккаунт содержит профиль \'Portal user\'. К сожалению, SolidLines Ticketing System не содержит модуля \'Request Management\'. Пожалуйста, свяжитесь с вашим администратором.',
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'Об этом SolidLines Ticketing System...',
	'UI:About:Title' => 'Об этом SolidLines Ticketing System',
	...
	'portal:backoffice' => 'SolidLines Ticketing System Back-Office интерфейс',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'Class:UserExternal+' => 'Пользователь, аутентифицируемый вне SolidLines Ticketing System',
	...
	'Class:UserLocal' => 'Пользователь SolidLines Ticketing System',
	'Class:UserLocal+' => 'Пользователь, аутентифицируемый через SolidLines Ticketing System',
	...
	'Attachments:UploadNotAllowedOnThisSystem' => 'Загрузка файлов НЕ разрешена в этой системе. За подробностями обратитесь к администратору вашего SolidLines Ticketing System',
...
or ask your SolidLines Ticketing System administrator if the SolidLines Ticketing System server disk is full.',
	...
	'Organization:Overview:Users' => 'Пользователи SolidLines Ticketing System этой организации',
...
If using OQL, objects proposed are limited to User rights. User Portal scopes are not applied.',
	...
	'Menu:iTopHub:Register+' => 'Перейдите в iTop Hub, чтобы обновить ваш экземпляр SolidLines Ticketing System',
	...
	'Menu:iTopHub:MyExtensions+' => 'Расширения, развернутые на данном экземпляре SolidLines Ticketing System',
