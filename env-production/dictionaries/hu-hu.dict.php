...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hiperhivatkozás egy (kis) képre, amely azt az alkalmazást ábrázolja, amellyel a SolidLines Ticketing System szinkronizálva van.',
	'Class:SynchroDataSource/Attribute:url_application' => 'Alkalmazás URL',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hiperhivatkozás a SolidLines Ticketing System objektumra abban a külső alkalmazásban, amellyel a SolidLines Ticketing System szinkronizálva van (ha van ilyen). Lehetséges helyörzők: $this->attribute$ és $replica->primary_key$',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:UserInternal+' => 'SolidLines Ticketing System-n belül létrehozott felhasználó',
	...
	'BooleanLabel:no' => 'Nem',
	'UI:Login:Title' => 'SolidLines Ticketing System bejelentkezés',
	'UI:WelcomeMenu:Title' => 'Üdvözli az SolidLines Ticketing System',
	...
	'UI:Login:Welcome' => 'Üdvözli az SolidLines Ticketing System!',
	...
	'UI:Login:ForgotPwdForm+' => 'SolidLines Ticketing System küldhet Önnek egy emailt, amelyben utasításokat talál a fiókja visszaállításához.',
	...
	'UI:ResetPwd-EmailSubject' => 'Állítsa vissza az SolidLines Ticketing System jelszavát',
	'UI:ResetPwd-EmailBody' => '<body><p>Ön vissza szeretné állítani az SolidLines Ticketing System jelszavát.</p><p>Kattintson erre a linkre <a href="%1$s">új jelszó</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Köszönjük, hogy az SolidLines Ticketing System-ot használja!',
	...
	'UI:AccessRO-All' => 'SolidLines Ticketing System csak olvasás módban',
	'UI:AccessRO-Users' => 'SolidLines Ticketing System csak olvasás módban a végfelhasználók számára',
	'UI:ApplicationEnvironment' => 'Alkalmazáskörnyezet: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => 'A jelszavak nem egyeznek!',
	'UI:Button:Login' => 'Belépés az SolidLines Ticketing System alkalmazásba',
	'UI:Login:Error:AccessRestricted' => 'SolidLines Ticketing System hozzáférés korlátozva. Kérem forduljon az SolidLines Ticketing System rendszergazdához!',
	'UI:Login:Error:AccessAdmin' => 'Adminisztrátori hozzáférés korlátozott. Kérem forduljon az SolidLines Ticketing System rendszergazdához!',
	...
	'UI:Title:BulkImport' => 'SolidLines Ticketing System - tömeges betöltés',
	'UI:Title:BulkImport+' => '',
	...
	'UI:UniversalSearchTitle' => 'SolidLines Ticketing System - Univerzális kereső',
	...
	'UI:CSVExport:LostChars+' => 'A letöltött fájl %1$s kódolású lesz. SolidLines Ticketing System olyan karaktereket észlelt, amelyek nem kompatibilisek ezzel a formátummal. Ezeket a karaktereket vagy helyettesítő karakterekkel helyettesítjük (pl. az ékezetes karakterek elveszítik az ékezetet), vagy elvetjük őket. Az adatokat a webböngészőből másolhatja/beillesztheti. Alternatívaként a rendszergazdához is fordulhat a kódolás megváltoztatásához (lásd a \'csv_file_default_charset\' paramétert).',
	...
	'UI:RunQuery:Title' => 'SolidLines Ticketing System - OQL lekérdezés értékelés',
	...
	'UI:WelcomeToITop' => 'Üdvözli az SolidLines Ticketing System',
	'UI:DetailsPageTitle' => 'SolidLines Ticketing System - %1$s - %2$s részletek',
	'UI:ErrorPageTitle' => 'SolidLines Ticketing System - Hiba',
	...
	'UI:SearchResultsPageTitle' => 'SolidLines Ticketing System - Keresés eredményei',
	...
	'UI:ModificationPageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s módosítása',
	'UI:ModificationTitle_Class_Object' => '%1$s: <span class=\\"hilite\\">%2$s</span> módosítása',
	'UI:ClonePageTitle_Object_Class' => 'SolidLines Ticketing System - %1$s - %2$s klón módosítása',
	'UI:CloneTitle_Class_Object' => '%1$s: <span class=\\"hilite\\">%2$s</span> klón',
	'UI:CreationPageTitle_Class' => 'SolidLines Ticketing System - %1$s létrehozása',
	...
	'UI:BulkDeletePageTitle' => 'SolidLines Ticketing System - Tömeges törlés',
	'UI:BulkDeleteTitle' => 'Válassza ki a törölni kívánt objektumokat:',
	'UI:PageTitle:ObjectCreated' => 'SolidLines Ticketing System objektum létrehozva.',
	...
	'UI:PageTitle:FatalError' => 'SolidLines Ticketing System - Végzetes hiba',
	'UI:SystemIntrusion' => 'Hozzáférés megtagadva. A művelet végrehajtása nem engedélyezett.',
	'UI:FatalErrorMessage' => 'Végzetes hiba, SolidLines Ticketing System nem tudja a műveletet folytatni',
	'UI:Error_Details' => 'Hiba: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'SolidLines Ticketing System Felhasználókezelés - Profiltervezés',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Az SolidLines Ticketing System alkalmazásban az értesítések teljesen testreszabhatók. Értesítések az objektumok két csoportjára épülnek: <i>eseményindítók és műveletek</i>.</p>
...
A művelet eseményindítóhoz rendelésekor kap egy sorszámot , amely meghatározza a műveletek végrehajtási sorrendjét.</p>',
	...
	'Portal:Title' => 'SolidLines Ticketing System felhasználói portál',
	'Portal:NoRequestMgmt' => 'Üdv, %1$s, Önt erre az oldalra irányítottuk át, mert fiókjában a \'Portál felhasználó\' profil van beállítva. Sajnos a SolidLines Ticketing System nem lett telepítve \'Kérelemkezelés\' funkcióval. Kérjük, lépjen kapcsolatba a rendszergazdával.',
...
<tr><td>s</td><td>seconds (2 számjegy, pl. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'SolidLines Ticketing System névjegye ...',
	'UI:About:Title' => 'SolidLines Ticketing System névjegye',
	...
	'portal:backoffice' => 'SolidLines Ticketing System Adminisztrációs felület',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'Class:UserLocal' => 'SolidLines Ticketing System felhasználó',
	...
	'Organization:Overview:Users' => 'SolidLines Ticketing System szervezeten belüli felhasználók',
...
If using OQL, objects proposed are limited to User rights. User Portal scopes are not applied.',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'SolidLines Ticketing System lemezterület',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Nézze meg az iTop Hub áruházát, az Ön egyablakos helyét, ahol csodálatos SolidLines Ticketing System bővítményeket talál!</br>Keresse meg azokat, amelyek segítenek a SolidLines Ticketing System testreszabásában és az Ön folyamataihoz való igazításában.</br><br/>Ha erről az oldalról csatlakozik a Hub-hoz, akkor a Hub-ra továbbítja a SolidLines Ticketing System példányára vonatkozó információkat.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Hiba történt telepítés közben!<br/>Az SolidLines Ticketing System konfigurációja NEM lett elmentve.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'A következő bővítményeket kézi másolással telepítettük a SolidLines Ticketing System %1$s könyvtárába:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Böngésszen az iTop Hub-ban, hogy megtalálja azokat a bővítményeket, amelyek segítenek testreszabni és az Ön folyamataihoz igazítani az SolidLines Ticketing System-ot !',
	'iTopHub:ExtensionNotInstalled' => 'Nincs telepítve',
	'iTopHub:GetMoreExtensions' => 'Bővítmények beszerzése az iTop Hub-ról...',
	'iTopHub:LandingWelcome' => 'Gratulálunk! A következő bővítményeket letöltöttük az iTop Hub-ról, és telepítettük az Ön SolidLines Ticketing System példányára.',
	'iTopHub:GoBackToITopBtn' => 'Vissza az SolidLines Ticketing System-hoz',
	...
	'iTopHub:DBBackupSentence' => 'A frissítés előtt biztonsági mentést készítünk az adatbázisról és az SolidLines Ticketing System konfigurációról.',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'SolidLines Ticketing System példány backup...',
...
FONTOS: Ha be van állítva, az \'Üzenet\' figyelmen kívül marad.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Rakjon ki egy gombot az üzenet alatt az objektum törléséhez az SolidLines Ticketing System',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Rakjon ki egy gombot az üzenet alatt az objektum szerkesztéséhez az SolidLines Ticketing System',
...
FONTOS: Ha be van állítva, a \'Üzenet\' és az összes \'Bot információ\' figyelmen kívül marad.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Rakjon ki egy gombot az üzenet alatt az objektum törléséhez az SolidLines Ticketing System',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Rakjon ki egy gombot az üzenet alatt az objektum szerkesztéséhez az SolidLines Ticketing System',
