...
/**
 * Classes and menus for itop-oauth-client (version 3.2.1)
 *
...
class OAuthClientAzure extends OAuthClient
{
  ...
  array (
    ...
    'is_blocking' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeString("tenant", array("sql"=>'tenant', "is_null_allowed"=>false, "default_value"=>'common', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class MenuCreation_itop_oauth_client extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['OAuthClient'] = new OQLMenuNode('OAuthClient', "SELECT OAuthClient", $__comp_menus__['Integrations']->GetIndex(), 100, true , 'OAuthClient', UR_ACTION_MODIFY, UR_ALLOWED_YES, null, true);
	}
