...
/**
 * Classes and menus for itop-service-mgmt-provider (version 3.2.1)
 *
...
class CustomerContract extends Contract
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("functionalcis_list", array("linked_class"=>'lnkCustomerContractToFunctionalCI', "ext_key_to_me"=>'customercontract_id', "ext_key_to_remote"=>'functionalci_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "with_php_computation"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("providercontracts_list", array("linked_class"=>'lnkCustomerContractToProviderContract', "ext_key_to_me"=>'customercontract_id', "ext_key_to_remote"=>'providercontract_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "with_php_computation"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class ServiceSubcategory extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("status", array("allowed_values"=>new ValueSetEnum("implementation,production,obsolete" ), "display_style"=>'list', "sql"=>'status', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("requesttemplates_list", array("linked_class"=>'RequestTemplate', "ext_key_to_me"=>'servicesubcategory_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_NONE, "allowed_values"=>null, "with_php_constraint"=>false, "with_php_computation"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class lnkCustomerContractToService extends cmdbAbstractObject
{
  ...
  array (
    ...
    'is_blocking' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeExternalField("sla_name", array("extkey_attcode"=>'sla_id', "target_attcode"=>'name', "allowed_values"=>null, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("coveragewindow_id", array("targetclass"=>'CoverageWindow', "allowed_values"=>null, "sql"=>'coveragewindow_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_AUTO, "allow_target_creation"=>false, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("coveragewindow_name", array("extkey_attcode"=>'coveragewindow_id', "target_attcode"=>'name', "allowed_values"=>null, "always_load_in_tables"=>false)));
...
class lnkCustomerContractToProviderContract extends cmdbAbstractObject
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel',
			'key_type' => 'autoincrement',
			'is_link' => true,
			'name_attcode' => array('customercontract_name', 'providercontract_name'),
			'image_attcode' => '',
			'state_attcode' => '',
...
class lnkCustomerContractToFunctionalCI extends cmdbAbstractObject
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel',
			'key_type' => 'autoincrement',
			'is_link' => true,
			'name_attcode' => array('customercontract_name', 'functionalci_name'),
			'image_attcode' => '',
			'state_attcode' => '',
...
class DeliveryModel extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("org_id", array("targetclass"=>'Organization', "allowed_values"=>null, "sql"=>'org_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_MANUAL, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("organization_name", array("extkey_attcode"=>'org_id', "target_attcode"=>'name', "allowed_values"=>null, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("description", array("sql"=>'description', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
