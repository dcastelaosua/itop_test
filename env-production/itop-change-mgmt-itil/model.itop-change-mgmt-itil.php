...
/**
 * Classes and menus for itop-change-mgmt-itil (version 3.2.1)
 *
...
abstract class Change extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("requestor_id", array("targetclass"=>'Person', "allowed_values"=>new ValueSetObjects("SELECT Person AS p WHERE p.org_id = :this->org_id"), "sql"=>'requestor_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array('org_id'), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("requestor_email", array("extkey_attcode"=>'requestor_id', "target_attcode"=>'email', "allowed_values"=>null, "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("supervisor_group_id", array("targetclass"=>'Team', "allowed_values"=>null, "sql"=>'supervisor_group_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("supervisor_group_name", array("extkey_attcode"=>'supervisor_group_id', "target_attcode"=>'name', "allowed_values"=>null, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("supervisor_id", array("targetclass"=>'Person', "allowed_values"=>new ValueSetObjects("SELECT Person AS p JOIN lnkPersonToTeam AS l ON l.person_id=p.id JOIN Team AS t ON l.team_id=t.id WHERE t.id = :this->supervisor_group_id"), "sql"=>'supervisor_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "allow_target_creation"=>false, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array('supervisor_group_id'), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("supervisor_email", array("extkey_attcode"=>'supervisor_id', "target_attcode"=>'email', "allowed_values"=>null, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("manager_group_id", array("targetclass"=>'Team', "allowed_values"=>null, "sql"=>'manager_group_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("manager_group_name", array("extkey_attcode"=>'manager_group_id', "target_attcode"=>'name', "allowed_values"=>null, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("manager_id", array("targetclass"=>'Person', "allowed_values"=>new ValueSetObjects("SELECT Person AS p JOIN lnkPersonToTeam AS l ON l.person_id=p.id JOIN Team AS t ON l.team_id=t.id WHERE t.id = :this->manager_group_id"), "sql"=>'manager_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "allow_target_creation"=>false, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array('manager_group_id'), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("manager_email", array("extkey_attcode"=>'manager_id', "target_attcode"=>'email', "allowed_values"=>null, "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeText("fallback", array("sql"=>'fallback', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("parent_id", array("targetclass"=>'Change', "allowed_values"=>new ValueSetObjects("\n            SELECT Change WHERE id != :this->id\n            "), "sql"=>'parent_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
abstract class ApprovedChange extends Change
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeString("approval_comment", array("sql"=>'approval_comment', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class NormalChange extends ApprovedChange
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeDateTime("acceptance_date", array("sql"=>'acceptance_date', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeText("acceptance_comment", array("sql"=>'acceptance_comment', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
