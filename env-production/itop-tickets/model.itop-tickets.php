...
/**
 * Classes and menus for itop-tickets (version 3.2.1)
 *
  ...
  array (
    ...
    array (
      ...
      'rejected' => 'closed',
		...
		MetaModel::Init_AddAttribute(new AttributeExternalField("team_email", array("extkey_attcode"=>'team_id', "target_attcode"=>'email', "allowed_values"=>null, "always_load_in_tables"=>false)));
...
;
	...
	protected function RegisterEventListeners()
	{
		...
		$this->RegisterCRUDListener("EVENT_DB_LINKS_CHANGED", 'OnLinksChangedTicket', 0, 'itop-tickets');
		// listenerId = UpdateImpactAnalysisLocal
		$this->RegisterCRUDListener("EVENT_DB_BEFORE_WRITE", 'OnBeforeWriteTicket', 0, 'itop-tickets');
	}
