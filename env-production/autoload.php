<?php
//
// File generated on 2026-02-12T21:40:40+0100
...
MetaModel::IncludeModule(MODULESROOT.'/molkobain-fontawesome5-pack/console/pageuiextension.class.inc.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-fontawesome5-pack/portal/portaluiextensionlegacy.class.inc.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-fontawesome5-pack/portal/portaluiextension.class.inc.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-handy-framework/compatibilitybridge.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-handy-framework/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-handy-framework/src/Compatibility/ClassesAliases.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-handy-framework/src/Core/AttributeMHFRackUnit.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-handy-framework/src/Extension/Hook/Console/PageUIExtension.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-newsroom-provider/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-newsroom-provider/src/Compatibility/ClassesAliases.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-newsroom-provider/src/Core/NewsroomProvider.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-newsroom-provider/src/Extension/Hook/Console/PageUIExtension.php');
...
MetaModel::IncludeModule(MODULESROOT.'/combodo-my-account/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-my-account/src/Hook/MyAccountPopupMenuExtension.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-my-account/model.combodo-my-account.php');
MetaModel::IncludeModule(MODULESROOT.'/email-reply/main.email-reply.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-attribute-class-set/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-attribute-class-set/src/Attribute/AttributeClassSet.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-attribute-class-set/model.itop-attribute-class-set.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-attribute-encrypted-password/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-attribute-encrypted-password/src/Model/CMDBChangeOpSetAttributeEncryptedPassword.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-attribute-encrypted-password/src/Attribute/AttributeEncryptedPassword.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-attribute-encrypted-password/model.itop-attribute-encrypted-password.php');
...
MetaModel::IncludeModule(MODULESROOT.'/itop-legacy-search-base/legacysearchadapter.class.inc.php');
...
MetaModel::IncludeModule(MODULESROOT.'/itop-portal-new-look-for-3.2-lts/../itop-portal-base/portal/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-portal-new-look-for-3.2-lts/src/Twig/PreferencesGlobal.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-portal-new-look-for-3.2-lts/src/Twig/AppIconUrlGlobal.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-portal-new-look-for-3.2-lts/src/Router/GlobalVariablesControllerRouter.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-portal-new-look-for-3.2-lts/src/Router/PreferencesRouter.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-portal-new-look-for-3.2-lts/vendor/autoload.php');
...
MetaModel::IncludeModule(MODULESROOT.'/itop-synchro-dashboard/model.itop-synchro-dashboard.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-virtualization-mgmt/model.itop-virtualization-mgmt.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-caselogs-toggler/common/confighelper.class.inc.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-caselogs-toggler/console/applicationuiextension.class.inc.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-caselogs-toggler/portal/apis/extensions/portaluiextensionlegacy.class.inc.php');
MetaModel::IncludeModule(MODULESROOT.'/molkobain-caselogs-toggler/portal/apis/extensions/portaluiextension.class.inc.php');
...
MetaModel::IncludeModule(MODULESROOT.'/combodo-my-account-user-info/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-my-account-user-info/model.combodo-my-account-user-info.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-oauth2-client/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-oauth2-client/model.combodo-oauth2-client.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-oauth2-client/src/Hook/ApplicationUIExtension.php');
...
return array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/combodo-backoffice-fullmoon-high-contrast-theme',
    'version' => '3.2.1',
  ),
  'combodo-backoffice-fullmoon-protanopia-deuteranopia-theme' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-backoffice-fullmoon-protanopia-deuteranopia-theme',
    'version' => '3.2.1',
  ),
  'combodo-backoffice-fullmoon-tritanopia-theme' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-backoffice-fullmoon-tritanopia-theme',
    'version' => '3.2.1',
  ),
  ...
  array (
    'root_dir' => $sCurrEnv.'/molkobain-fontawesome5-pack',
    'version' => '1.4.0',
  ),
  'molkobain-handy-framework' => 
  array (
    'root_dir' => $sCurrEnv.'/molkobain-handy-framework',
    'version' => '1.7.0',
  ),
  'molkobain-newsroom-provider' => 
  array (
    'root_dir' => $sCurrEnv.'/molkobain-newsroom-provider',
    'version' => '1.3.0',
  ),
  'molkobain-portal-tree-service-catalog' => 
  array (
    'root_dir' => $sCurrEnv.'/molkobain-portal-tree-service-catalog',
    'version' => '1.0.0',
  ),
  'templates-base' => 
  array (
  ...
  'combodo-my-account' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-my-account',
    'version' => '1.0.0',
  ),
  'email-reply' => 
  array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/itop-attribute-class-set',
    'version' => '1.0.0',
  ),
  'itop-attribute-encrypted-password' => 
  array (
    'root_dir' => $sCurrEnv.'/itop-attribute-encrypted-password',
    'version' => '1.0.0',
  ),
  'itop-config-mgmt' => 
  array (
  ...
  'itop-legacy-search-base' => 
  array (
    'root_dir' => $sCurrEnv.'/itop-legacy-search-base',
    'version' => '1.1.2',
  ),
  'itop-oauth-client' => 
  array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/itop-portal-new-look-for-3.2-lts',
    'version' => '1.0.1',
  ),
  'itop-problem-mgmt' => 
  array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/itop-synchro-dashboard',
    'version' => '1.2.2',
  ),
  ...
  array (
    'root_dir' => $sCurrEnv.'/molkobain-caselogs-toggler',
    'version' => '1.6.0',
  ),
  'authent-token' => 
  array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/combodo-my-account-user-info',
    'version' => '1.0.0',
  ),
  'combodo-oauth2-client' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-oauth2-client',
    'version' => '1.0.3',
  ),
