...
Dict::Add('EN GB', 'British English', 'British English', array(
	...
	'Class:ServiceSubcategory/Attribute:requesttemplates_list+' => 'If they are multiple, the end user will pick and fill a single template, but not all.',
));
...
Dict::Add('EN GB', 'British English', 'British English', array(
	...
	'Class:RequestTemplate+' => 'A request template defines a set of additional fields which will be prompted in the request form, based on the selected service subcategory.',
	...
	'Class:RequestTemplate/Attribute:servicesubcategory_id+' => 'A request template applies to one and only one service subcategory',
	...
	'Class:UserRequest/Attribute:service_details+' => 'Additional information depending on the service',
	'Class:Incident/Attribute:service_details' => 'Service details',
	'Class:Incident/Attribute:service_details+' => 'Additional information depending on the service',
));
