...
/**
 * Classes and menus for itop-request-template (version 2.3.6)
 *
...
class RequestTemplate extends Template
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("servicesubcategory_id", array("targetclass"=>'ServiceSubcategory', "allowed_values"=>new ValueSetObjects("SELECT ServiceSubcategory WHERE service_id =:this->service_id"), "sql"=>'servicesubcategory_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array('service_id'), "always_load_in_tables"=>false)));
