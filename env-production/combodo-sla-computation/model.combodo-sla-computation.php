...
/**
 * Classes and menus for combodo-sla-computation (version 2.4.3)
 *
...
class CoverageWindow extends _CoverageWindow_
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("interval_list", array("linked_class"=>'CoverageWindowInterval', "ext_key_to_me"=>'coverage_window_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_INPLACE, "allowed_values"=>null, "with_php_constraint"=>false, "with_php_computation"=>false, "depends_on"=>array(), "always_load_in_tables"=>false, "tracking_level"=>LINKSET_TRACKING_ALL)));
...
class CoverageWindowInterval extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeExternalKey("coverage_window_id", array("targetclass"=>'CoverageWindow', "allowed_values"=>new ValueSetObjects("SELECT CoverageWindow"), "sql"=>'coverage_window_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_AUTO, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false, "tracking_level"=>ATTRIBUTE_TRACKING_NONE)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("coverage_window_name", array("extkey_attcode"=>'coverage_window_id', "target_attcode"=>'name', "allowed_values"=>null, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("weekday", array("allowed_values"=>new ValueSetEnum("friday,monday,saturday,sunday,thursday,tuesday,wednesday" ), "display_style"=>'list', "sql"=>'weekday', "default_value"=>'monday', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("start_time", array("sql"=>'start_time', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "validation_pattern"=>'^(([01]?[0-9]|2[0-3]):[0-5][0-9])$', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("end_time", array("sql"=>'end_time', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "validation_pattern"=>'^(([01]?[0-9]|2[0-3]):[0-5][0-9])|24:00$', "always_load_in_tables"=>false)));
...
class Holiday extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("name", array("sql"=>'name', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDate("date", array("sql"=>'date', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("calendar_id", array("targetclass"=>'HolidayCalendar', "allowed_values"=>new ValueSetObjects("SELECT HolidayCalendar"), "sql"=>'calendar_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_AUTO, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("calendar_name", array("extkey_attcode"=>'calendar_id', "target_attcode"=>'name', "allowed_values"=>null, "always_load_in_tables"=>false)));
...
class HolidayCalendar extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("name", array("sql"=>'name', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("holiday_list", array("linked_class"=>'Holiday', "ext_key_to_me"=>'calendar_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "with_php_computation"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
