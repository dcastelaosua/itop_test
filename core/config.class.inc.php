...
define('ITOP_APPLICATION', 'SolidLines Ticketing System');
define('ITOP_APPLICATION_SHORT', 'SolidLines Ticketing System');
 ...
 */
define('ITOP_VERSION', '3.2.2-1');

define('ITOP_VERSION_NAME', 'Fullmoon');
define('ITOP_REVISION', '17851');
define('ITOP_BUILD_DATE', '2025-08-19 11:30:00');
...
class Config
{
	...
	protected $m_aSettings = [
		...
		'app_icon_url'                       => [
			...
			'default'             => 'https://helpdesk.solidlines.io',
			'value'               => '',
			'source_of_value'     => '',
			'show_in_conf_sample' => false,
		],
